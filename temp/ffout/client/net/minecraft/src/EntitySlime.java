    ...
    implements IMob
{
    ...
    {
        field_21064_bx.func_21129_b(16, new Byte((byte)i));
    ...
    public void func_352_a(NBTTagCompound nbttagcompound)
    {
        ...
        nbttagcompound.func_758_a("Size", func_25027_v() - 1);
    }

    public void func_357_b(NBTTagCompound nbttagcompound)
    {
        super.func_357_b(nbttagcompound);
        func_441_c(nbttagcompound.func_756_e("Size") + 1);
    }
    ...
    public void func_6378_b(EntityPlayer entityplayer)
    {
        ...
        {
            int i = func_25027_v();
            if(func_420_c(entityplayer) && (double)func_379_d(entityplayer) < 0.59999999999999998D * (double)i && entityplayer.func_396_a(DamageSource.func_35525_a(this), func_40130_ai()))
            {
