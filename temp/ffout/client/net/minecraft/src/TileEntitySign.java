...
public class TileEntitySign extends TileEntity
{
    ...
    public void func_481_b(NBTTagCompound nbttagcompound)
    {
        ...
        nbttagcompound.func_754_a("Text1", field_826_a[0]);
        nbttagcompound.func_754_a("Text2", field_826_a[1]);
        nbttagcompound.func_754_a("Text3", field_826_a[2]);
        nbttagcompound.func_754_a("Text4", field_826_a[3]);
    }
    ...
    public void func_482_a(NBTTagCompound nbttagcompound)
    {
        ...
        for(int i = 0; i < 4; i++)
        {
            field_826_a[i] = nbttagcompound.func_755_i((new StringBuilder()).append("Text").append(i + 1).toString());
