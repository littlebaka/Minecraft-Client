...
public class TerrainTextureManager
{
    ...
    public TerrainTextureManager()
    {
        ...
        for(int i = 0; i < 256; i++)
        {
            if(Block.field_345_n[i] != null)
            {
                field_1182_g[i * 3 + 0] = Block.field_345_n[i].func_218_a(1);
                field_1182_g[i * 3 + 1] = Block.field_345_n[i].func_218_a(2);
                field_1182_g[i * 3 + 2] = Block.field_345_n[i].func_218_a(3);
            }
        }
    ...
    public void func_799_a(IsoImageBuffer isoimagebuffer)
    {
        ...
        for(int i1 = l - 1; i1 >= j; i1--)
        {
            for(int j1 = k - 1; j1 >= i; j1--)
            {
                ...
                int i2 = k1 + l1;
                boolean flag = true;
                for(int j2 = 0; j2 < world.field_35472_c; j2++)
                {
                    ...
                    Block block = Block.field_345_n[world.func_600_a(j1, j2, i1)];
                    if(block == null)
                    {
                        flag = false;
                        continue;
                    ...
                    {
                        int l2 = world.func_600_a(j1, j2 + 1, i1);
                        if(l2 != 0 && Block.field_345_n[l2].field_356_bn == Material.field_1332_f)
                        {
                            continue;
                        }
                        float f1 = ((float)j2 / ((float)world.field_35472_c - 1.0F)) * 0.6F + 0.4F;
                        float f2 = world.func_598_c(j1, j2 + 1, i1) * f1;
                        if(k2 < 0 || k2 >= 544)
                        {
                            continue;
                        }
                    ...
                    float f = ((float)j2 / ((float)world.field_35472_c - 1.0F)) * 0.6F + 0.4F;
                    if(k2 >= 0 && k2 < 544)
                    {
                        int i3 = i2 + k2 * 32;
                        int k3 = field_1182_g[block.field_376_bc * 3 + 0];
                        float f3 = (world.func_598_c(j1, j2 + 1, i1) * 0.8F + 0.2F) * f;
                        int j4 = k3;
                        if(i2 >= 0)
                        {
                            float f5 = f3;
                    ...
                    int j3 = i2 + (k2 + 1) * 32;
                    int l3 = field_1182_g[block.field_376_bc * 3 + 1];
                    float f4 = world.func_598_c(j1 - 1, j2, i1) * 0.8F + 0.2F;
                    int k4 = field_1182_g[block.field_376_bc * 3 + 2];
                    float f7 = world.func_598_c(j1, j2, i1 + 1) * 0.8F + 0.2F;
                    if(i2 >= 0)
                    {
                        float f8 = f4 * f * 0.6F;
