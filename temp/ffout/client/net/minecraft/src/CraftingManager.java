...
public class CraftingManager
{
    ...
    private CraftingManager()
    {
        ...
        func_1121_a(new ItemStack(Block.field_410_al, 3, 3), new Object[] {
            "###", Character.valueOf('#'), Block.field_335_x
        });
        func_1121_a(new ItemStack(Block.field_410_al, 3, 0), new Object[] {
            "###", Character.valueOf('#'), Block.field_338_u
        });
        func_1121_a(new ItemStack(Block.field_410_al, 3, 1), new Object[] {
            "###", Character.valueOf('#'), Block.field_9264_Q
        });
        func_1121_a(new ItemStack(Block.field_410_al, 3, 2), new Object[] {
            "###", Character.valueOf('#'), Block.field_334_y
        });
        func_1121_a(new ItemStack(Block.field_410_al, 3, 4), new Object[] {
            "###", Character.valueOf('#'), Block.field_409_am
        });
        func_1121_a(new ItemStack(Block.field_410_al, 3, 5), new Object[] {
            "###", Character.valueOf('#'), Block.field_35285_bn
        });
        func_1121_a(new ItemStack(Block.field_441_aG, 2), new Object[] {
            "# #", "###", "# #", Character.valueOf('#'), Item.field_266_B
        });
        ...
        func_1121_a(new ItemStack(Block.field_334_y, 4), new Object[] {
            "#", Character.valueOf('#'), Block.field_385_K
        });
    ...
    void func_1121_a(ItemStack itemstack, Object aobj[])
    {
        ...
        field_1662_b.add(new ShapedRecipes(j, k, aitemstack, itemstack));
    }
    ...
    void func_21187_b(ItemStack itemstack, Object aobj[])
    {
        ...
        field_1662_b.add(new ShapelessRecipes(itemstack, arraylist));
    }
    ...
    public ItemStack func_21188_a(InventoryCrafting inventorycrafting)
    {
        ...
        ItemStack itemstack1 = null;
        for(int j = 0; j < inventorycrafting.func_469_c(); j++)
        {
            ItemStack itemstack2 = inventorycrafting.func_468_c(j);
            if(itemstack2 == null)
            {
                continue;
            }
