...
public class MapItemRenderer
{
    ...
    public MapItemRenderer(FontRenderer fontrenderer, GameSettings gamesettings, RenderEngine renderengine)
    {
        ...
        field_28158_b = renderengine.func_1074_a(new BufferedImage(128, 128, 2));
    ...
    public void func_28157_a(EntityPlayer entityplayer, RenderEngine renderengine, MapData mapdata)
    {
        ...
        GL11.glEnable(3008);
        GL11.glDisable(3042);
        renderengine.func_1076_b(renderengine.func_1070_a("/misc/mapicons.png"));
        ...
        field_28160_d.func_873_b(mapdata.field_28168_a, j, k, 0xff000000);
        GL11.glPopMatrix();
    }
}
