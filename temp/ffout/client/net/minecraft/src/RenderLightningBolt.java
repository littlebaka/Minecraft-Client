        ...
        for(int i = 0; i < 4; i++)
        {
            ...
            for(int k = 0; k < 3; k++)
            {
                ...
                for(int j1 = l; j1 >= i1; j1--)
                {
                    ...
                    float f2 = 0.5F;
                    tessellator.func_986_a(0.9F * f2, 0.9F * f2, 1.0F * f2, 0.3F);
                    ...
                    for(int k1 = 0; k1 < 5; k1++)
                    {
                        ...
                        tessellator.func_991_a(d13 + d5, d1 + (double)(j1 * 16), d14 + d6);
                        tessellator.func_991_a(d11 + d7, d1 + (double)((j1 + 1) * 16), d12 + d8);
                    }
