...
public class MapGenCavesHell extends MapGenBase
{
    ...
    protected void func_4129_a(int i, int j, byte abyte0[], double d, double d1, 
            double d2)
    {
        func_4128_a(i, j, abyte0, d, d1, d2, 1.0F + field_1305_b.nextFloat() * 6F, 0.0F, 0.0F, -1, -1, 0.5D);
    }
            ...
            double d3)
    {
        ...
        for(; k < l; k++)
        {
            double d6 = 1.5D + (double)(MathHelper.func_1106_a(((float)k * 3.141593F) / (float)l) * f * 1.0F);
            double d7 = d6 * d3;
            ...
            if(l1 > field_35625_d.field_35472_c - 8)
            {
                l1 = field_35625_d.field_35472_c - 8;
            }
            if(d10 < 0)
            {
                d10 = 0;
            ...
            for(int j2 = d8; !flag2 && j2 < k1; j2++)
            {
                for(int l2 = d10; !flag2 && l2 < i2; l2++)
                {
                    ...
                    {
                        int j3 = (j2 * 16 + l2) * field_35625_d.field_35472_c + i3;
                        if(i3 < 0 || i3 >= field_35625_d.field_35472_c)
                        {
                            continue;
                        }
                        if(abyte0[j3] == Block.field_397_D.field_376_bc || abyte0[j3] == Block.field_395_E.field_376_bc)
                        {
                            flag2 = true;
                        }
            ...
            for(int k2 = d8; k2 < k1; k2++)
            {
                ...
                for(int k3 = d10; k3 < i2; k3++)
                {
                    ...
                    int l3 = (k2 * 16 + k3) * field_35625_d.field_35472_c + l1;
    ...
    {
        int i1 = field_1305_b.nextInt(field_1305_b.nextInt(field_1305_b.nextInt(10) + 1) + 1);
        ...
        for(int j1 = 0; j1 < i1; j1++)
        {
            ...
            double d1 = field_1305_b.nextInt(world.field_35472_c);
