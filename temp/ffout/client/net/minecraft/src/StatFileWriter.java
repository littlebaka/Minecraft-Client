...
//            StatsSyncher, StatBase, J_InvalidSyntaxException, J_JdomParser, 
//            J_JsonRootNode, J_JsonNode, J_JsonStringNode, StatList, 
//            MD5String, Achievement, Session
...
public class StatFileWriter
{
    ...
    public static String func_27185_a(String s, String s1, Map map)
    {
        ...
        for(Iterator iterator = map.keySet().iterator(); iterator.hasNext(); stringbuilder1.append(map.get(statbase)).append(","))
        {
            ...
            stringbuilder.append("\r\n    {\"").append(statbase.field_25071_d).append("\":").append(map.get(statbase));
    ...
    public boolean func_27183_a(Achievement achievement)
    {
    ...
    {
        return achievement.field_25076_c == null || func_27183_a(achievement.field_25076_c);
    }
