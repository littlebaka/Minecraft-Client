...
//            ItemEnderEye, ItemMonsterPlacer, ItemRecord, StatList, 
...
public class Item
{
    ...
    public final int func_196_a(ItemStack itemstack)
    {
        return func_27009_a(itemstack.func_21181_i());
    }
    ...
    {
        field_332_a = (new StringBuilder()).append("item.").append(s).toString();
        return this;
    }

    public String func_40400_h(ItemStack itemstack)
    {
        String s = func_21011_b(itemstack);
        if(s == null)
        {
            return "";
        } else
    ...
    public boolean func_46059_i(ItemStack itemstack)
    {
        return true;
    }
    ...
    {
        String s = (new StringBuilder()).append("").append(StringTranslate.func_20162_a().func_20161_b(func_40400_h(itemstack))).toString().trim();
        return s;
    }
    ...
    protected MovingObjectPosition func_40402_a(World world, EntityPlayer entityplayer, boolean flag)
    {
        ...
        MovingObjectPosition movingobjectposition = world.func_28105_a(vec3d, vec3d1, flag, !flag);
