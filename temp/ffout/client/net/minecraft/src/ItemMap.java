...
public class ItemMap extends ItemMapBase
{
    ...
    public static MapData func_28013_a(short word0, World world)
    {
        ...
        MapData mapdata = (MapData)world.func_28103_a(net.minecraft.src.MapData.class, (new StringBuilder()).append("map_").append(word0).toString());
        if(mapdata == null)
        {
            int i = world.func_28101_b("map");
    ...
    {
        String s = (new StringBuilder()).append("map_").append(itemstack.func_21181_i()).toString();
        MapData mapdata = (MapData)world.func_28103_a(net.minecraft.src.MapData.class, (new StringBuilder()).append("map_").append(itemstack.func_21181_i()).toString());
        if(mapdata == null)
        {
            itemstack.func_28156_b(world.func_28101_b("map"));
            String s1 = (new StringBuilder()).append("map_").append(itemstack.func_21181_i()).toString();
            mapdata = new MapData(s1);
            mapdata.field_28180_b = world.func_22144_v().func_22293_c();
            mapdata.field_28179_c = world.func_22144_v().func_22300_e();
            mapdata.field_28177_e = 3;
            mapdata.field_28178_d = (byte)world.field_4209_q.field_4218_e;
    ...
    {
        if(world.field_4209_q.field_4218_e != mapdata.field_28178_d)
        {
            return;
        }
        char c = '\200';
        ...
        int l = MathHelper.func_1108_b(entity.field_611_ak - (double)j) / i + c / 2;
        int i1 = MathHelper.func_1108_b(entity.field_609_am - (double)k) / i + c1 / 2;
        int j1 = 128 / i;
        if(world.field_4209_q.field_6478_e)
        {
            j1 /= 2;
        }
        ...
        for(int k1 = (l - j1) + 1; k1 < l + j1; k1++)
        {
            ...
            for(int j2 = i1 - j1 - 1; j2 < i1 + j1; j2++)
            {
                ...
                int i4 = 0;
                int ai[] = new int[256];
                Chunk chunk = world.func_673_a(i3, j3);
                int j4 = i3 & 0xf;
                int k4 = j3 & 0xf;
                int l4 = 0;
                double d1 = 0.0D;
    ...
    public void func_28009_b(ItemStack itemstack, World world, EntityPlayer entityplayer)
    {
        ...
        mapdata.field_28180_b = MathHelper.func_1108_b(entityplayer.field_611_ak);
        mapdata.field_28179_c = MathHelper.func_1108_b(entityplayer.field_609_am);
        mapdata.field_28177_e = 3;
        mapdata.field_28178_d = (byte)world.field_4209_q.field_4218_e;
        mapdata.func_28164_a();
    }
