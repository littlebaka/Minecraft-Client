...
public class EntityArrow extends Entity
{
    ...
    public EntityArrow(World world, EntityLiving entityliving, float f)
    {
        ...
        field_28020_a = entityliving instanceof EntityPlayer;
        func_371_a(0.5F, 0.5F);
        ...
        func_408_a(field_608_an, field_607_ao, field_606_ap, f * 1.5F, 1.0F);
    }
    ...
    {
        nbttagcompound.func_749_a("xTile", (short)field_9319_c);
        nbttagcompound.func_749_a("yTile", (short)field_9318_d);
        nbttagcompound.func_749_a("zTile", (short)field_9317_e);
        nbttagcompound.func_761_a("inTile", (byte)field_9316_f);
        nbttagcompound.func_761_a("inData", (byte)field_28019_h);
        nbttagcompound.func_761_a("shake", (byte)field_688_a);
        nbttagcompound.func_761_a("inGround", (byte)(field_9315_g ? 1 : 0));
        nbttagcompound.func_748_a("player", field_28020_a);
        nbttagcompound.func_765_a("damage", field_46026_at);
    }

    public void func_357_b(NBTTagCompound nbttagcompound)
    {
        field_9319_c = nbttagcompound.func_745_d("xTile");
        field_9318_d = nbttagcompound.func_745_d("yTile");
        field_9317_e = nbttagcompound.func_745_d("zTile");
        field_9316_f = nbttagcompound.func_746_c("inTile") & 0xff;
        field_28019_h = nbttagcompound.func_746_c("inData") & 0xff;
        field_688_a = nbttagcompound.func_746_c("shake") & 0xff;
        field_9315_g = nbttagcompound.func_746_c("inGround") == 1;
        field_28020_a = nbttagcompound.func_760_m("player");
        if(nbttagcompound.func_751_b("damage"))
        {
            field_46026_at = nbttagcompound.func_757_h("damage");
        }
    }
    ...
    public void func_6378_b(EntityPlayer entityplayer)
    {
        ...
        if(field_9315_g && field_28020_a && field_688_a <= 0 && entityplayer.field_778_b.func_504_a(new ItemStack(Item.field_226_j, 1)))
        {
