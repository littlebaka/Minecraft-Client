...
public class EntityDragon extends EntityDragonBase
{
    ...
    public void func_425_j()
    {
        ...
        for(int j = 0; j < 3; j++)
        {
            ...
            dragonpart.func_370_e_();
            dragonpart.func_365_c(field_611_ak - (double)((f8 * f16 + f14 * f17) * f5), ((field_610_al + (ad2[1] - ad[1]) * 1.0D) - (double)((f17 + f16) * f6)) + 1.5D, field_609_am + (double)((f9 * f16 + f15 * f17) * f5), 0.0F, 0.0F);
        }
    ...
    private boolean func_40158_a(AxisAlignedBB axisalignedbb)
    {
        ...
        int j = MathHelper.func_1108_b(axisalignedbb.field_1697_b);
        int k = MathHelper.func_1108_b(axisalignedbb.field_1704_c);
        int l = MathHelper.func_1108_b(axisalignedbb.field_1703_d);
        int i1 = MathHelper.func_1108_b(axisalignedbb.field_1702_e);
        int j1 = MathHelper.func_1108_b(axisalignedbb.field_1701_f);
        boolean flag = false;
        boolean flag1 = false;
        ...
        if(flag1)
        {
            double d = axisalignedbb.field_1698_a + (axisalignedbb.field_1703_d - axisalignedbb.field_1698_a) * (double)field_9312_bd.nextFloat();
            double d1 = axisalignedbb.field_1697_b + (axisalignedbb.field_1702_e - axisalignedbb.field_1697_b) * (double)field_9312_bd.nextFloat();
            double d2 = axisalignedbb.field_1704_c + (axisalignedbb.field_1701_f - axisalignedbb.field_1704_c) * (double)field_9312_bd.nextFloat();
    ...
    public boolean func_40156_a(DragonPart dragonpart, DamageSource damagesource, int i)
    {
        ...
        field_40179_aC = null;
        if((damagesource.func_35532_a() instanceof EntityPlayer) || damagesource == DamageSource.field_35548_k)
        {
    ...
    protected void func_40120_m_()
    {
        ...
        if(field_40178_aA == 200)
        {
            ...
            int i1 = (5 + field_9312_bd.nextInt(2) * 2) - 1;
            int j1 = (5 + field_9312_bd.nextInt(2) * 2) - 1;
            if(field_9312_bd.nextInt(2) == 0)
            {
                i1 = 0;
            } else
            {
    ...
    {
        int k = field_615_ag.field_35472_c / 2;
            ...
            for(int j1 = i - l; j1 <= i + l; j1++)
            {
                for(int k1 = j - l; k1 <= j + l; k1++)
                {
                    ...
                    if(i1 < k)
                    {
                        ...
                        {
                            field_615_ag.func_690_d(j1, i1, k1, Block.field_403_A.field_376_bc);
                        }
                        continue;
                    }
                    if(i1 > k)
                    {
                        field_615_ag.func_690_d(j1, i1, k1, 0);
                        continue;
                    }
                    if(d2 > (double)(l - 1) - 0.5D)
                    {
                    ...
                    {
                        field_615_ag.func_690_d(j1, i1, k1, Block.field_40209_bI.field_376_bc);
                    }
                }
        ...
        field_615_ag.func_690_d(i, k + 0, j, Block.field_403_A.field_376_bc);
        field_615_ag.func_690_d(i, k + 1, j, Block.field_403_A.field_376_bc);
        field_615_ag.func_690_d(i, k + 2, j, Block.field_403_A.field_376_bc);
        field_615_ag.func_690_d(i - 1, k + 2, j, Block.field_404_ar.field_376_bc);
        field_615_ag.func_690_d(i + 1, k + 2, j, Block.field_404_ar.field_376_bc);
        field_615_ag.func_690_d(i, k + 2, j - 1, Block.field_404_ar.field_376_bc);
        field_615_ag.func_690_d(i, k + 2, j + 1, Block.field_404_ar.field_376_bc);
        field_615_ag.func_690_d(i, k + 3, j, Block.field_403_A.field_376_bc);
        field_615_ag.func_690_d(i, k + 4, j, Block.field_41050_bK.field_376_bc);
