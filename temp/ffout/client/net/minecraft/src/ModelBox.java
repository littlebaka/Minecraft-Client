...
public class ModelBox
{
            ...
            int l, int i1, float f3)
    {
        ...
        }, i + i1 + k, j + i1, i + i1 + k + i1, j + i1 + l, modelrenderer.field_35971_a, modelrenderer.field_35970_b);
        ...
        }, i + 0, j + i1, i + i1, j + i1 + l, modelrenderer.field_35971_a, modelrenderer.field_35970_b);
        ...
        }, i + i1, j + 0, i + i1 + k, j + i1, modelrenderer.field_35971_a, modelrenderer.field_35970_b);
        ...
        }, i + i1 + k, j + i1, i + i1 + k + k, j + 0, modelrenderer.field_35971_a, modelrenderer.field_35970_b);
        ...
        }, i + i1, j + i1, i + i1 + k, j + i1 + l, modelrenderer.field_35971_a, modelrenderer.field_35970_b);
        ...
        }, i + i1 + k + i1, j + i1, i + i1 + k + i1 + k, j + i1 + l, modelrenderer.field_35971_a, modelrenderer.field_35970_b);
        if(modelrenderer.field_1404_g)
        {
            for(int j1 = 0; j1 < field_40680_i.length; j1++)
            {
                field_40680_i[j1].func_809_a();
            }
    ...
    public void func_40670_a(Tessellator tessellator, float f)
    {
        ...
        {
            field_40680_i[i].func_808_a(tessellator, f);
        }
