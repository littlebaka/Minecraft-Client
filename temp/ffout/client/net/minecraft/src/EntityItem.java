...
public class EntityItem extends Entity
{
    ...
    {
        nbttagcompound.func_749_a("Health", (byte)field_802_f);
        nbttagcompound.func_749_a("Age", (short)field_800_b);
        nbttagcompound.func_763_a("Item", field_801_a.func_1086_a(new NBTTagCompound()));
    }

    public void func_357_b(NBTTagCompound nbttagcompound)
    {
        field_802_f = nbttagcompound.func_745_d("Health") & 0xff;
        field_800_b = nbttagcompound.func_745_d("Age");
        NBTTagCompound nbttagcompound1 = nbttagcompound.func_743_k("Item");
        field_801_a = ItemStack.func_35864_a(nbttagcompound1);
        if(field_801_a == null)
        {
            func_395_F();
        }
    ...
    public void func_6378_b(EntityPlayer entityplayer)
    {
        ...
        if(field_805_c == 0 && entityplayer.field_778_b.func_504_a(field_801_a))
        {
            ...
            {
                entityplayer.func_27026_a(AchievementList.field_40464_w);
            }
            if(field_801_a.field_1617_c == Item.field_40417_bo.field_291_aS)
            {
                entityplayer.func_27026_a(AchievementList.field_40465_z);
            }
