...
public class ModelEnderman extends ModelBiped
{
    ...
    public void func_863_a(float f, float f1, float f2, float f3, float f4, float f5)
    {
        ...
        float f7 = 0.4F;
        if(field_1283_d.field_1407_d > f7)
        {
            field_1283_d.field_1407_d = f7;
        }
        if(field_1282_e.field_1407_d > f7)
        {
            field_1282_e.field_1407_d = f7;
        }
        if(field_1283_d.field_1407_d < -f7)
        {
            field_1283_d.field_1407_d = -f7;
        ...
        if(field_1281_f.field_1407_d > f7)
        {
            field_1281_f.field_1407_d = f7;
        }
        if(field_1280_g.field_1407_d > f7)
        {
            field_1280_g.field_1407_d = f7;
        }
        if(field_1281_f.field_1407_d < -f7)
        {
            field_1281_f.field_1407_d = -f7;
        ...
        field_1281_f.field_1409_b = 9F + f6;
        field_1280_g.field_1409_b = 9F + f6;
        field_1286_a.field_1408_c = -0F;
        field_1286_a.field_1409_b = f6 + 1.0F;
        ...
        {
            float f8 = 1.0F;
            field_1286_a.field_1409_b -= f8 * 5F;
        }
    }
}
