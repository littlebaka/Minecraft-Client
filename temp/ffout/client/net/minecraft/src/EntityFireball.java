...
public class EntityFireball extends Entity
{
    ...
    public EntityFireball(World world, EntityLiving entityliving, double d, double d1, double d2)
    {
        ...
        func_371_a(1.0F, 1.0F);
        func_365_c(entityliving.field_611_ak, entityliving.field_610_al, entityliving.field_609_am, entityliving.field_605_aq, entityliving.field_604_ar);
        func_347_a(field_611_ak, field_610_al, field_609_am);
        field_9292_aO = 0.0F;
        field_608_an = field_607_ao = field_606_ap = 0.0D;
        d += field_9312_bd.nextGaussian() * 0.40000000000000002D;
        d1 += field_9312_bd.nextGaussian() * 0.40000000000000002D;
        d2 += field_9312_bd.nextGaussian() * 0.40000000000000002D;
    ...
    public void func_370_e_()
    {
        super.func_370_e_();
        func_40046_d(1);
        if(!field_615_ag.field_1026_y && (field_9397_j == null || field_9397_j.field_646_aA))
        {
            func_395_F();
        }
        if(field_9398_i)
    ...
    protected void func_40071_a(MovingObjectPosition movingobjectposition)
    {
        if(!field_615_ag.field_1026_y)
        {
            ...
            {
                if(!movingobjectposition.field_1168_g.func_396_a(DamageSource.func_35530_a(this, field_9397_j), 4));
            }
    ...
    {
        nbttagcompound.func_749_a("xTile", (short)field_9402_e);
        nbttagcompound.func_749_a("yTile", (short)field_9401_f);
        nbttagcompound.func_749_a("zTile", (short)field_9400_g);
        nbttagcompound.func_761_a("inTile", (byte)field_9399_h);
        nbttagcompound.func_761_a("inGround", (byte)(field_9398_i ? 1 : 0));
    }

    public void func_357_b(NBTTagCompound nbttagcompound)
    {
        field_9402_e = nbttagcompound.func_745_d("xTile");
        field_9401_f = nbttagcompound.func_745_d("yTile");
        field_9400_g = nbttagcompound.func_745_d("zTile");
        field_9399_h = nbttagcompound.func_746_c("inTile") & 0xff;
        field_9398_i = nbttagcompound.func_746_c("inGround") == 1;
    }
    ...
    public boolean func_396_a(DamageSource damagesource, int i)
    {
        ...
        {
            Vec3D vec3d = damagesource.func_35532_a().func_4037_H();
            if(vec3d != null)
            {
            ...
            if(damagesource.func_35532_a() instanceof EntityLiving)
            {
                field_9397_j = (EntityLiving)damagesource.func_35532_a();
            }
            return true;
        } else
        {
