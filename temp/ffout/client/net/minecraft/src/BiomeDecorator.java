...
public class BiomeDecorator
{
    ...
    public BiomeDecorator(BiomeGenBase biomegenbase)
    {
        ...
        field_40722_x = new MapGenWaterlily();
        field_40721_y = 0;
        field_35911_r = 0;
        field_35910_s = 2;
        field_35909_t = 1;
    ...
    protected void func_35882_b()
    {
        ...
        for(int j2 = 0; j2 < field_35910_s; j2++)
        {
            ...
            int i11 = field_35890_C.nextInt(field_35889_B.field_35472_c);
            ...
            if(field_35890_C.nextInt(4) == 0)
            {
                ...
                int j11 = field_35890_C.nextInt(field_35889_B.field_35472_c);
        ...
        {
            int j7 = 1;
            int k11 = field_35885_D + field_35890_C.nextInt(16) + 8;
            int j15 = field_35890_C.nextInt(field_35889_B.field_35472_c);
            int l17 = field_35886_E + field_35890_C.nextInt(16) + 8;
            (new WorldGenTallGrass(Block.field_9257_X.field_376_bc, j7)).func_516_a(field_35889_B, field_35890_C, k11, j15, l17);
        }

        for(int l2 = 0; l2 < field_35908_u; l2++)
        {
            int k7 = field_35885_D + field_35890_C.nextInt(16) + 8;
            int l11 = field_35890_C.nextInt(field_35889_B.field_35472_c);
        ...
        for(int i3 = 0; i3 < field_40721_y; i3++)
        {
            ...
            int l15;
            for(l15 = field_35890_C.nextInt(field_35889_B.field_35472_c); l15 > 0 && field_35889_B.func_600_a(l7, l15 - 1, i12) == 0; l15--) { }
        ...
        for(int j3 = 0; j3 < field_35907_v; j3++)
        {
            ...
            if(field_35890_C.nextInt(8) == 0)
            {
                ...
                int j16 = field_35890_C.nextInt(field_35889_B.field_35472_c);
        ...
        if(field_35890_C.nextInt(4) == 0)
        {
            ...
            int k8 = field_35890_C.nextInt(field_35889_B.field_35472_c);
        ...
        if(field_35890_C.nextInt(8) == 0)
        {
            ...
            int l8 = field_35890_C.nextInt(field_35889_B.field_35472_c);
        ...
        for(int i4 = 0; i4 < field_35906_w; i4++)
        {
            ...
            int k16 = field_35890_C.nextInt(field_35889_B.field_35472_c);
        ...
        for(int j4 = 0; j4 < 10; j4++)
        {
            ...
            int k13 = field_35890_C.nextInt(field_35889_B.field_35472_c);
        ...
        if(field_35890_C.nextInt(32) == 0)
        {
            ...
            int k9 = field_35890_C.nextInt(field_35889_B.field_35472_c);
        ...
        for(int l4 = 0; l4 < field_35916_x; l4++)
        {
            ...
            int i14 = field_35890_C.nextInt(field_35889_B.field_35472_c);
        ...
        if(field_40719_K)
        {
            for(int i5 = 0; i5 < 50; i5++)
            {
                ...
                int j14 = field_35890_C.nextInt(field_35890_C.nextInt(field_35889_B.field_35472_c - 8) + 8);
            ...
            for(int j5 = 0; j5 < 20; j5++)
            {
                ...
                int k14 = field_35890_C.nextInt(field_35890_C.nextInt(field_35890_C.nextInt(field_35889_B.field_35472_c - 16) + 8) + 8);
    ...
    protected void func_35884_a(int i, WorldGenerator worldgenerator, int j, int k)
    {
        for(int l = 0; l < i; l++)
        {
            ...
            worldgenerator.func_516_a(field_35889_B, field_35890_C, i1, j1, k1);
        }
    ...
    {
        func_35884_a(20, field_35893_d, 0, field_35889_B.field_35472_c);
        func_35884_a(10, field_35894_e, 0, field_35889_B.field_35472_c);
        func_35884_a(20, field_35891_f, 0, field_35889_B.field_35472_c);
        func_35884_a(20, field_35892_g, 0, field_35889_B.field_35472_c / 2);
        func_35884_a(2, field_35904_h, 0, field_35889_B.field_35472_c / 4);
        func_35884_a(8, field_35905_i, 0, field_35889_B.field_35472_c / 8);
        func_35884_a(1, field_35902_j, 0, field_35889_B.field_35472_c / 8);
        func_35883_b(1, field_35903_k, field_35889_B.field_35472_c / 8, field_35889_B.field_35472_c / 8);
    }
}
