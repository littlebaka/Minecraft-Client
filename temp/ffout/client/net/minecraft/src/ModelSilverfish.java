...
public class ModelSilverfish extends ModelBase
{
    ...
    public void func_864_b(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
    {
        ...
        for(int i = 0; i < field_35400_a.length; i++)
        {
            field_35400_a[i].func_922_a(f5);
        }

        for(int j = 0; j < field_35398_b.length; j++)
        {
            field_35398_b[j].func_922_a(f5);
        }
    ...
    public void func_863_a(float f, float f1, float f2, float f3, float f4, float f5)
    {
        for(int i = 0; i < field_35400_a.length; i++)
        {
            field_35400_a[i].field_1406_e = MathHelper.func_1114_b(f2 * 0.9F + (float)i * 0.15F * 3.141593F) * 3.141593F * 0.05F * (float)(1 + Math.abs(i - 2));
            field_35400_a[i].field_1410_a = MathHelper.func_1106_a(f2 * 0.9F + (float)i * 0.15F * 3.141593F) * 3.141593F * 0.2F * (float)Math.abs(i - 2);
        }
