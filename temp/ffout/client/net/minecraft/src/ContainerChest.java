...
public class ContainerChest extends Container
{
    ...
    public ContainerChest(IInventory iinventory, IInventory iinventory1)
    {
        ...
        field_27282_b = iinventory1.func_469_c() / 9;
        ...
        for(int j = 0; j < field_27282_b; j++)
        {
            ...
            {
                func_20117_a(new Slot(iinventory1, i1 + j * 9, 8 + i1 * 18, 18 + j * 18));
            }
        ...
        for(int k = 0; k < 3; k++)
        {
            ...
            {
                func_20117_a(new Slot(iinventory, j1 + k * 9 + 9, 8 + j1 * 18, 103 + k * 18 + i));
            }
        ...
        for(int l = 0; l < 9; l++)
        {
            func_20117_a(new Slot(iinventory, l, 8 + l * 18, 161 + i));
        }
