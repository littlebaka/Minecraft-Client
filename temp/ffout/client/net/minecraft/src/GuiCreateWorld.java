...
//            GuiButton, ChatAllowedCharacters, MathHelper, EnumWorldType, 
...
public class GuiCreateWorld extends GuiScreen
{
    ...
    public void func_6448_a()
    {
        ...
        field_22134_h = new GuiTextField(this, field_6451_g, field_951_c / 2 - 100, 60, 200, 20, field_41047_y);
        field_22134_h.field_22082_a = true;
        field_22134_h.func_22066_a(32);
        field_22133_i = new GuiTextField(this, field_6451_g, field_951_c / 2 - 100, 60, 200, 20, field_41048_x);
        func_22129_j();
        func_35363_g();
    }
...
_L3:
    ...
    protected void func_572_a(GuiButton guibutton)
    {
        ...
        if(guibutton.field_938_f == 0)
        {
            ...
            field_945_b.func_6247_b(field_22132_k, field_22134_h.func_22071_a(), new WorldSettings(l, i, field_35365_g, field_40232_h, EnumWorldType.values()[field_46030_z]));
            field_945_b.func_6272_a(null);
        } else
    ...
    {
        if(field_22134_h.field_22082_a && !field_35368_i)
        {
            field_22134_h.func_22072_a(c, i);
            field_41047_y = field_22134_h.func_22071_a();
        } else
        if(field_22133_i.field_22082_a && field_35368_i)
        {
    ...
    {
        if(field_22134_h.field_22082_a)
        {
            field_22134_h.func_27106_a(false);
            field_22133_i.func_27106_a(true);
        } else
        {
            field_22134_h.func_27106_a(true);
            field_22133_i.func_27106_a(false);
        }
    }
}
