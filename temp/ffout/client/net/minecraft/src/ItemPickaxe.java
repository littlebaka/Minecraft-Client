...
public class ItemPickaxe extends ItemTool
{
    ...
    {
        super(i, 2, enumtoolmaterial, field_329_aX);
    }

    public boolean func_4018_a(Block block)
    {
        if(block == Block.field_405_aq)
        {
            return field_20927_a.func_21208_d() == 3;
        }
        if(block == Block.field_389_ay || block == Block.field_391_ax)
        {
            return field_20927_a.func_21208_d() >= 2;
        }
        if(block == Block.field_413_ai || block == Block.field_390_H)
        {
            return field_20927_a.func_21208_d() >= 2;
        }
        if(block == Block.field_412_aj || block == Block.field_388_I)
        {
            return field_20927_a.func_21208_d() >= 1;
        }
        if(block == Block.field_9266_O || block == Block.field_9267_N)
        {
            return field_20927_a.func_21208_d() >= 1;
        }
        if(block == Block.field_433_aO || block == Block.field_432_aP)
        {
            return field_20927_a.func_21208_d() >= 2;
        }
        if(block.field_356_bn == Material.field_1334_d)
        {
            return true;
        }
        return block.field_356_bn == Material.field_1333_e;
    }

    public float func_204_a(ItemStack itemstack, Block block)
    {
        if(block != null && (block.field_356_bn == Material.field_1333_e || block.field_356_bn == Material.field_1334_d))
        {
            return field_324_aY;
        } else
        {
