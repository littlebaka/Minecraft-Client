...
public class EntityXPOrb extends Entity
{
    ...
    {
        nbttagcompound.func_749_a("Health", (byte)field_35123_e);
        nbttagcompound.func_749_a("Age", (short)field_35124_b);
        nbttagcompound.func_749_a("Value", (short)field_35125_ap);
    }

    public void func_357_b(NBTTagCompound nbttagcompound)
    {
        field_35123_e = nbttagcompound.func_745_d("Health") & 0xff;
        field_35124_b = nbttagcompound.func_745_d("Age");
        field_35125_ap = nbttagcompound.func_745_d("Value");
    }
