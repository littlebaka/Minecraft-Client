...
public class MapGenRavine extends MapGenBase
{
            ...
            int k, int i1, double d3)
    {
        ...
        float f5 = 1.0F;
        for(int k1 = 0; k1 < field_35625_d.field_35472_c; k1++)
        {
        ...
        for(; k < i1; k++)
        {
            ...
            float f6 = MathHelper.func_1114_b(f2);
            float f7 = MathHelper.func_1106_a(f2);
            d += MathHelper.func_1114_b(f1) * f6;
            d1 += f7;
            d2 += MathHelper.func_1106_a(f1) * f6;
            f2 *= 0.7F;
            f2 += f4 * 0.05F;
            f1 += f3 * 0.05F;
            f4 *= 0.8F;
...
label0:
                    ...
                    do
                    {
                        ...
                        if((d12 * d12 + d13 * d13) * (double)field_35627_a[j4] + (d14 * d14) / 6D < 1.0D)
                        {
                            ...
                            if(byte0 == Block.field_338_u.field_376_bc || byte0 == Block.field_336_w.field_376_bc || byte0 == Block.field_337_v.field_376_bc)
                            {
                                ...
                                {
                                    abyte0[i4] = 0;
                                    if(flag2 && abyte0[i4 - 1] == Block.field_336_w.field_376_bc)
                                    {
    ...
    protected void func_868_a(World world, int i, int j, int k, int l, byte abyte0[])
    {
        ...
        for(int j1 = 0; j1 < i1; j1++)
        {
            ...
            func_35626_a(field_1305_b.nextLong(), k, l, abyte0, d, d1, d2, f2, f, f1, 0, 0, 3D);
        }
