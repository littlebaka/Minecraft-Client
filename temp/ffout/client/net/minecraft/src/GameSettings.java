...
public class GameSettings
{
    ...
    public String func_20102_a(int i)
    {
        ...
        return stringtranslate.func_20163_a(field_1564_t[i].field_1371_a);
    }

    public String func_1047_d(int i)
    {
        int j = field_1564_t[i].field_1370_b;
    ...
    public void func_1048_a(EnumOptions enumoptions, float f)
    {
    ...
    public void func_1045_b(EnumOptions enumoptions, int i)
    {
        ...
        {
            field_1580_e = field_1580_e + i & 3;
        }
        if(enumoptions == EnumOptions.GUI_SCALE)
        {
            field_25148_H = field_25148_H + i & 3;
        }
        ...
        {
            field_1577_h = (field_1577_h + i + 3) % 3;
        }
        if(enumoptions == EnumOptions.DIFFICULTY)
        {
            field_1561_w = field_1561_w + i & 3;
        }
    ...
    public String func_1043_a(EnumOptions enumoptions)
    {
        StringTranslate stringtranslate = StringTranslate.func_20162_a();
        ...
        if(enumoptions == EnumOptions.RENDER_DISTANCE)
        {
            return (new StringBuilder()).append(s).append(stringtranslate.func_20163_a(field_20105_z[field_1580_e])).toString();
        }
        if(enumoptions == EnumOptions.DIFFICULTY)
        {
            return (new StringBuilder()).append(s).append(stringtranslate.func_20163_a(field_20106_A[field_1561_w])).toString();
        }
        if(enumoptions == EnumOptions.GUI_SCALE)
        {
            return (new StringBuilder()).append(s).append(stringtranslate.func_20163_a(field_25147_K[field_25148_H])).toString();
        }
        if(enumoptions == EnumOptions.PARTICLES)
        {
            return (new StringBuilder()).append(s).append(stringtranslate.func_20163_a(field_41086_T[field_41087_P])).toString();
        }
        if(enumoptions == EnumOptions.FRAMERATE_LIMIT)
        {
            return (new StringBuilder()).append(s).append(StatCollector.func_25200_a(field_30006_M[field_1577_h])).toString();
        }
        if(enumoptions == EnumOptions.GRAPHICS)
        {
            if(field_1576_i)
