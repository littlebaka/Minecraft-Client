...
public class RegionFile
{
    ...
    {
        func_22211_a((new StringBuilder()).append("REGION ").append(s).append(" ").append(field_22212_b.getName()).append("[").append(i).append(",").append(j).append("] = ").append(s1).toString());
    }

    private void func_22197_a(String s, int i, int j, int k, String s1)
    {
        func_22211_a((new StringBuilder()).append("REGION ").append(s).append(" ").append(field_22212_b.getName()).append("[").append(i).append(",").append(j).append("] ").append(k).append("B = ").append(s1).toString());
    }
    ...
    public synchronized DataInputStream func_22210_a(int i, int j)
    {
        ...
        try
        {
            ...
            if(j1 > 4096 * i1)
            {
                func_22201_b("READ", i, j, (new StringBuilder()).append("invalid length: ").append(j1).append(" > 4096 * ").append(i1).toString());
                return null;
            }
    ...
    private void func_22200_a(int i, byte abyte0[], int j)
        throws IOException
    {
    ...
    private void func_22198_a(int i, int j, int k)
        throws IOException
    {
