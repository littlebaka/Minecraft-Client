...
//            Block, Material, RenderGlobal, Potion, 
//            OpenGlHelper, WorldProvider, Profiler, MouseHelper, 
//            ScaledResolution, GuiIngame, GuiScreen, GuiParticle, 
//            ChunkProviderLoadOrGenerate, ClippingHelperImpl, Frustrum, ICamera, 
//            RenderHelper, EffectRenderer, InventoryPlayer, WorldChunkManager, 
//            BiomeGenBase, EntitySmokeFX, EntityRainFX, Tessellator, 
//            PotionEffect, PlayerCapabilities
...
public class EntityRenderer
{
    ...
    public EntityRenderer(Minecraft minecraft)
    {
        ...
        field_35818_d = minecraft.field_6315_n.func_1074_a(new BufferedImage(16, 16, 1));
    ...
    public void func_910_a(float f)
    {
        ...
        field_1388_h.field_6305_x = field_1388_h.field_22009_h.func_416_a(d, f);
        double d1 = d;
        Vec3D vec3d = field_1388_h.field_22009_h.func_427_e(f);
        ...
        Vec3D vec3d1 = field_1388_h.field_22009_h.func_430_f(f);
        Vec3D vec3d2 = vec3d.func_1257_c(vec3d1.field_1776_a * d, vec3d1.field_1775_b * d, vec3d1.field_1779_c * d);
        field_1385_k = null;
        float f1 = 1.0F;
        java.util.List list = field_1388_h.field_6324_e.func_659_b(field_1388_h.field_22009_h, field_1388_h.field_22009_h.field_601_au.func_1170_a(vec3d1.field_1776_a * d, vec3d1.field_1775_b * d, vec3d1.field_1779_c * d).func_1177_b(f1, f1, f1));
        double d2 = 0.0D;
        for(int i = 0; i < list.size(); i++)
        {
            ...
            AxisAlignedBB axisalignedbb = entity.field_601_au.func_1177_b(f2, f2, f2);
    ...
    private float func_914_d(float f, boolean flag)
    {
        if(field_35823_q > 0)
        {
            return 90F;
        ...
        if(flag)
        {
            f1 += field_1388_h.field_6304_y.field_35379_L * 40F;
            f1 *= field_35813_N + (field_35812_M - field_35813_N) * f;
        }
        if(entityplayer.func_40114_aH() <= 0)
        {
            float f2 = (float)entityplayer.field_712_J + f;
            f1 /= (1.0F - 500F / (f2 + 500F)) * 2.0F + 1.0F;
        }
        int i = ActiveRenderInfo.func_41066_a(field_1388_h.field_6324_e, entityplayer, f);
    ...
    private void func_920_e(float f)
    {
        ...
        float f1 = (float)entityliving.field_715_G - f;
        if(entityliving.func_40114_aH() <= 0)
        {
            float f2 = (float)entityliving.field_712_J + f;
        ...
        {
            f1 /= entityliving.field_9332_M;
            f1 = MathHelper.func_1106_a(f1 * f1 * f1 * f1 * 3.141593F);
            float f3 = entityliving.field_9331_N;
    ...
    private void func_917_f(float f)
    {
        ...
        {
            EntityPlayer entityplayer = (EntityPlayer)field_1388_h.field_22009_h;
            float f1 = entityplayer.field_9290_aS - entityplayer.field_9291_aR;
            float f2 = -(entityplayer.field_9290_aS + f1 * f);
    ...
    private void func_4138_g(float f)
    {
        EntityLiving entityliving = field_1388_h.field_22009_h;
        float f1 = entityliving.field_9292_aO - 1.62F;
        double d = entityliving.field_9285_at + (entityliving.field_611_ak - entityliving.field_9285_at) * (double)f;
        double d1 = (entityliving.field_9284_au + (entityliving.field_610_al - entityliving.field_9284_au) * (double)f) - (double)f1;
        ...
        if(entityliving.func_22051_K())
        {
            ...
            if(!field_1388_h.field_6304_y.field_22273_E)
            {
                ...
                GL11.glRotatef(entityliving.field_603_as + (entityliving.field_605_aq - entityliving.field_603_as) * f + 180F, 0.0F, -1F, 0.0F);
                GL11.glRotatef(entityliving.field_602_at + (entityliving.field_604_ar - entityliving.field_602_at) * f, -1F, 0.0F, 0.0F);
            }
        } else
        if(field_1388_h.field_6304_y.field_1560_x > 0)
        {
            ...
            {
                float f3 = entityliving.field_605_aq;
                float f5 = entityliving.field_604_ar;
                if(field_1388_h.field_6304_y.field_1560_x == 2)
                {
                    f5 += 180F;
                }
                double d4 = (double)(-MathHelper.func_1106_a((f3 / 180F) * 3.141593F) * MathHelper.func_1114_b((f5 / 180F) * 3.141593F)) * d3;
                double d5 = (double)(MathHelper.func_1114_b((f3 / 180F) * 3.141593F) * MathHelper.func_1114_b((f5 / 180F) * 3.141593F)) * d3;
                double d6 = (double)(-MathHelper.func_1106_a((f5 / 180F) * 3.141593F)) * d3;
                for(int l = 0; l < 8; l++)
                {
                    float f6 = (l & 1) * 2 - 1;
                    float f7 = (l >> 1 & 1) * 2 - 1;
                    ...
                    f7 *= 0.1F;
                    f8 *= 0.1F;
                    MovingObjectPosition movingobjectposition = field_1388_h.field_6324_e.func_645_a(Vec3D.func_1248_b(d + (double)f6, d1 + (double)f7, d2 + (double)f8), Vec3D.func_1248_b((d - d4) + (double)f6 + (double)f8, (d1 - d6) + (double)f7, (d2 - d5) + (double)f8));
                    if(movingobjectposition == null)
                    {
                        continue;
                    }
                ...
                GL11.glRotatef(entityliving.field_604_ar - f5, 1.0F, 0.0F, 0.0F);
                GL11.glRotatef(entityliving.field_605_aq - f3, 0.0F, 1.0F, 0.0F);
                GL11.glTranslatef(0.0F, 0.0F, (float)(-d3));
                GL11.glRotatef(f3 - entityliving.field_605_aq, 0.0F, 1.0F, 0.0F);
                GL11.glRotatef(f5 - entityliving.field_604_ar, 1.0F, 0.0F, 0.0F);
            }
        } else
        {
        ...
        if(!field_1388_h.field_6304_y.field_22273_E)
        {
            GL11.glRotatef(entityliving.field_602_at + (entityliving.field_604_ar - entityliving.field_602_at) * f, 1.0F, 0.0F, 0.0F);
            GL11.glRotatef(entityliving.field_603_as + (entityliving.field_605_aq - entityliving.field_603_as) * f + 180F, 0.0F, 1.0F, 0.0F);
        }
        GL11.glTranslatef(0.0F, f1, 0.0F);
        d = entityliving.field_9285_at + (entityliving.field_611_ak - entityliving.field_9285_at) * (double)f;
        d1 = (entityliving.field_9284_au + (entityliving.field_610_al - entityliving.field_9284_au) * (double)f) - (double)f1;
        d2 = entityliving.field_9283_av + (entityliving.field_609_am - entityliving.field_9283_av) * (double)f;
        field_27288_B = field_1388_h.field_6323_f.func_27307_a(d, d1, d2, f);
    }

    private void func_4139_a(float f, int i)
    {
        field_1387_i = 256 >> field_1388_h.field_6304_y.field_1580_e;
        ...
        if(field_21155_l != 1.0D)
        {
            ...
            GLU.gluPerspective(func_914_d(f, true), (float)field_1388_h.field_6326_c / (float)field_1388_h.field_6325_d, 0.05F, field_1387_i * 2.0F);
        } else
        {
            GLU.gluPerspective(func_914_d(f, true), (float)field_1388_h.field_6326_c / (float)field_1388_h.field_6325_d, 0.05F, field_1387_i * 2.0F);
        }
        ...
        float f3 = field_1388_h.field_6322_g.field_28025_B + (field_1388_h.field_6322_g.field_28026_A - field_1388_h.field_6322_g.field_28025_B) * f;
        if(f3 > 0.0F)
        {
            int j = 20;
            ...
            f4 *= f4;
            GL11.glRotatef(((float)field_1386_j + f) * (float)j, 0.0F, 1.0F, 1.0F);
    ...
    private void func_4135_b(float f, int i)
    {
        ...
        if(field_21155_l != 1.0D)
        {
            GL11.glTranslatef((float)field_21154_m, (float)(-field_21153_n), 0.0F);
            GL11.glScaled(field_21155_l, field_21155_l, 1.0D);
            GLU.gluPerspective(func_914_d(f, false), (float)field_1388_h.field_6326_c / (float)field_1388_h.field_6325_d, 0.05F, field_1387_i * 2.0F);
        } else
        {
            GLU.gluPerspective(func_914_d(f, false), (float)field_1388_h.field_6326_c / (float)field_1388_h.field_6325_d, 0.05F, field_1387_i * 2.0F);
        }
    ...
    public void func_4136_b(float f)
    {
        ...
        if(field_1388_h.field_6289_L)
        {
            ...
            float f1 = field_1388_h.field_6304_y.field_1582_c * 0.6F + 0.2F;
            float f2 = f1 * f1 * f1 * 8F;
            float f3 = (float)field_1388_h.field_6299_B.field_1114_a * f2;
            float f4 = (float)field_1388_h.field_6299_B.field_1113_b * f2;
            int l = 1;
            ...
            if(field_1388_h.field_6304_y.field_22274_D)
            {
                field_40682_H += f3;
                field_40683_I += f4;
                float f5 = f - field_40681_L;
                field_40681_L = f;
                f3 = field_40684_J * f5;
                f4 = field_40685_K * f5;
                field_1388_h.field_6322_g.func_346_d(f3, f4 * (float)l);
            } else
            {
                field_1388_h.field_6322_g.func_346_d(f3, f4 * (float)l);
            }
        ...
        int i1 = j - (Mouse.getY() * j) / field_1388_h.field_6325_d - 1;
        char c = '\310';
        ...
        if(field_1388_h.field_6324_e != null)
        {
            ...
            {
                func_4134_c(f, field_28133_I + (long)(0x3b9aca00 / c));
            }
            ...
            {
                field_1388_h.field_6308_u.func_4066_a(f, field_1388_h.field_6313_p != null, k, i1);
            }
            Profiler.func_40662_b();
        } else
        {
        ...
        {
            GL11.glClear(256);
            field_1388_h.field_6313_p.func_571_a(k, i1, f);
            if(field_1388_h.field_6313_p != null && field_1388_h.field_6313_p.field_25091_h != null)
            {
                field_1388_h.field_6313_p.field_25091_h.func_25087_a(f);
            }
        }
    }

    public void func_4134_c(float f, long l)
    {
        Profiler.func_40663_a("lightTex");
        if(field_35815_V)
        {
        ...
        double d = entityliving.field_638_aI + (entityliving.field_611_ak - entityliving.field_638_aI) * (double)f;
        double d1 = entityliving.field_637_aJ + (entityliving.field_610_al - entityliving.field_637_aJ) * (double)f;
        double d2 = entityliving.field_636_aK + (entityliving.field_609_am - entityliving.field_636_aK) * (double)f;
        ...
        for(int i = 0; i < 2; i++)
        {
            ...
            field_1388_h.field_6323_f.func_960_a(frustrum, f);
            if(i == 0)
            {
                ...
                do
                {
                    if(field_1388_h.field_6323_f.func_948_a(entityliving, false) || l == 0L)
                    {
                        break;
                    }
            ...
            if(field_35823_q == 0)
            {
                ...
                renderglobal.func_951_a(entityliving.func_427_e(f), frustrum, f);
                func_35806_b(f);
                ...
                effectrenderer.func_1189_a(entityliving, f);
                func_35810_a(f);
                if(field_1388_h.field_6305_x != null && entityliving.func_393_a(Material.field_1332_f) && (entityliving instanceof EntityPlayer))
                {
                    EntityPlayer entityplayer = (EntityPlayer)entityliving;
                    GL11.glDisable(3008);
                    Profiler.func_40661_c("outline");
                    renderglobal.func_959_a(entityplayer, field_1388_h.field_6305_x, 0, entityplayer.field_778_b.func_494_a(), f);
                    renderglobal.func_955_b(entityplayer, field_1388_h.field_6305_x, 0, entityplayer.field_778_b.func_494_a(), f);
                    GL11.glEnable(3008);
                }
            }
            GL11.glDisable(3042);
            ...
            GL11.glDisable(2884);
            GL11.glBindTexture(3553, field_1388_h.field_6315_n.func_1070_a("/terrain.png"));
            if(field_1388_h.field_6304_y.field_1576_i)
            {
                ...
                int i1 = renderglobal.func_943_a(entityliving, 1, f);
                if(field_1388_h.field_6304_y.field_1578_g)
                {
                    if(field_28134_b == 0)
                    {
            ...
            GL11.glEnable(2884);
            GL11.glDisable(3042);
            if(field_21155_l == 1.0D && (entityliving instanceof EntityPlayer) && field_1388_h.field_6305_x != null && !entityliving.func_393_a(Material.field_1332_f))
            {
                EntityPlayer entityplayer1 = (EntityPlayer)entityliving;
                GL11.glDisable(3008);
                Profiler.func_40661_c("outline");
                renderglobal.func_959_a(entityplayer1, field_1388_h.field_6305_x, 0, entityplayer1.field_778_b.func_494_a(), f);
                renderglobal.func_955_b(entityplayer1, field_1388_h.field_6305_x, 0, entityplayer1.field_778_b.func_494_a(), f);
                GL11.glEnable(3008);
            }
    ...
    private void func_916_c()
    {
        ...
        for(int j1 = 0; j1 < i1; j1++)
        {
            ...
            if(i2 > j + byte0 || i2 < j - byte0 || !world.func_4075_a().func_4073_a(k1, l1).func_27077_d() || world.func_4075_a().func_35554_b(k1, i2, l1) <= 0.2F)
            {
                continue;
            }
            ...
            field_1388_h.field_6321_h.func_1192_a(new EntityRainFX(world, (float)k1 + f1, (double)((float)i2 + 0.1F) - Block.field_345_n[j2].field_368_bg, (float)l1 + f2));
        }
    ...
    protected void func_27286_d(float f)
    {
        float f1 = field_1388_h.field_6324_e.func_27162_g(f);
        if(f1 <= 0.0F)
        {
            return;
        }
        ...
        if(field_35822_i == null)
        {
            ...
            for(int i = 0; i < 32; i++)
            {
                for(int j = 0; j < 32; j++)
                {
                    float f2 = j - 16;
                    float f3 = i - 16;
                    float f4 = MathHelper.func_1113_c(f2 * f2 + f3 * f3);
        ...
        BiomeGenBase abiomegenbase[] = world.func_4075_a().func_4069_a(k - k1, i1 - k1, k1 * 2 + 1, k1 * 2 + 1);
        float af[] = world.func_4075_a().func_40539_b(k - k1, i1 - k1, k1 * 2 + 1, k1 * 2 + 1);
        int l1 = 0;
        byte byte0 = -1;
        float f5 = (float)field_1386_j + f;
        if(field_1388_h.field_6304_y.field_1576_i)
        {
            k1 = 10;
        }
        ...
        for(int i2 = i1 - k1; i2 <= i1 + k1; i2++)
        {
            for(int j2 = k - k1; j2 <= k + k1; j2++)
            {
                ...
                field_1383_m.setSeed(j2 * j2 * 3121 + j2 * 0x2b24abb ^ i2 * i2 * 0x66397 + i2 * 13761);
                float f9 = af[l1 - 1];
                if(world.func_4075_a().func_40540_a(f9, l2) >= 0.15F)
                {
                    if(byte0 != 0)
                    {
                        if(byte0 >= 0)
                    ...
                    float f10 = (((float)(field_1386_j + j2 * j2 * 3121 + j2 * 0x2b24abb + i2 * i2 * 0x66397 + i2 * 13761 & 0x1f) + f) / 32F) * (3F + field_1383_m.nextFloat());
                    double d3 = (double)((float)j2 + 0.5F) - entityliving.field_611_ak;
                    double d4 = (double)((float)i2 + 0.5F) - entityliving.field_609_am;
                    float f14 = MathHelper.func_1109_a(d3 * d3 + d4 * d4) / (float)k1;
                    float f15 = 1.0F;
                    tessellator.func_35835_b(world.func_35451_b(j2, k3, i2, 0));
                    tessellator.func_986_a(f15, f15, f15, ((1.0F - f14 * f14) * 0.5F + 0.5F) * f1);
                    tessellator.func_984_b(-d * 1.0D, -d1 * 1.0D, -d2 * 1.0D);
                    tessellator.func_983_a((double)((float)j2 - f6) + 0.5D, i3, (double)((float)i2 - f7) + 0.5D, 0.0F * f8, ((float)i3 * f8) / 4F + f10 * f8);
                    tessellator.func_983_a((double)((float)j2 + f6) + 0.5D, i3, (double)((float)i2 + f7) + 0.5D, 1.0F * f8, ((float)i3 * f8) / 4F + f10 * f8);
                    tessellator.func_983_a((double)((float)j2 + f6) + 0.5D, j3, (double)((float)i2 + f7) + 0.5D, 1.0F * f8, ((float)j3 * f8) / 4F + f10 * f8);
                    tessellator.func_983_a((double)((float)j2 - f6) + 0.5D, j3, (double)((float)i2 - f7) + 0.5D, 0.0F * f8, ((float)j3 * f8) / 4F + f10 * f8);
                ...
                float f11 = ((float)(field_1386_j & 0x1ff) + f) / 512F;
                float f12 = field_1383_m.nextFloat() + f5 * 0.01F * (float)field_1383_m.nextGaussian();
                float f13 = field_1383_m.nextFloat() + f5 * (float)field_1383_m.nextGaussian() * 0.001F;
                double d5 = (double)((float)j2 + 0.5F) - entityliving.field_611_ak;
                double d6 = (double)((float)i2 + 0.5F) - entityliving.field_609_am;
                float f16 = MathHelper.func_1109_a(d5 * d5 + d6 * d6) / (float)k1;
                float f17 = 1.0F;
                tessellator.func_35835_b((world.func_35451_b(j2, k3, i2, 0) * 3 + 0xf000f0) / 4);
                tessellator.func_986_a(f17, f17, f17, ((1.0F - f16 * f16) * 0.3F + 0.5F) * f1);
                tessellator.func_984_b(-d * 1.0D, -d1 * 1.0D, -d2 * 1.0D);
                tessellator.func_983_a((double)((float)j2 - f6) + 0.5D, i3, (double)((float)i2 - f7) + 0.5D, 0.0F * f8 + f12, ((float)i3 * f8) / 4F + f11 * f8 + f13);
                tessellator.func_983_a((double)((float)j2 + f6) + 0.5D, i3, (double)((float)i2 + f7) + 0.5D, 1.0F * f8 + f12, ((float)i3 * f8) / 4F + f11 * f8 + f13);
                tessellator.func_983_a((double)((float)j2 + f6) + 0.5D, j3, (double)((float)i2 + f7) + 0.5D, 1.0F * f8 + f12, ((float)j3 * f8) / 4F + f11 * f8 + f13);
                tessellator.func_983_a((double)((float)j2 - f6) + 0.5D, j3, (double)((float)i2 - f7) + 0.5D, 0.0F * f8 + f12, ((float)j3 * f8) / 4F + f11 * f8 + f13);
                tessellator.func_984_b(0.0D, 0.0D, 0.0D);
            }
    ...
    private void func_4137_h(float f)
    {
        World world = field_1388_h.field_6324_e;
        EntityLiving entityliving = field_1388_h.field_22009_h;
        float f1 = 1.0F / (float)(4 - field_1388_h.field_6304_y.field_1580_e);
        f1 = 1.0F - (float)Math.pow(f1, 0.25D);
        Vec3D vec3d = world.func_4079_a(field_1388_h.field_22009_h, f);
        ...
        if(field_1388_h.field_6304_y.field_1580_e < 2)
        {
            Vec3D vec3d2 = MathHelper.func_1106_a(world.func_35456_d(f)) <= 0.0F ? Vec3D.func_1248_b(1.0D, 0.0D, 0.0D) : Vec3D.func_1248_b(-1D, 0.0D, 0.0D);
            float f6 = (float)entityliving.func_430_f(f).func_35612_b(vec3d2);
            if(f6 < 0.0F)
            {
                f6 = 0.0F;
            }
            if(f6 > 0.0F)
            {
                float af[] = world.field_4209_q.func_4097_b(world.func_619_c(f), f);
                if(af != null)
                {
                    f6 *= af[3];
                    field_4270_e = field_4270_e * (1.0F - f6) + af[0] * f6;
                    field_4269_f = field_4269_f * (1.0F - f6) + af[1] * f6;
                    field_4268_g = field_4268_g * (1.0F - f6) + af[2] * f6;
                }
            }
        }
        ...
        int i = ActiveRenderInfo.func_41066_a(field_1388_h.field_6324_e, entityliving, f);
        if(field_27288_B)
        {
            Vec3D vec3d3 = world.func_628_d(f);
        ...
        float f11 = field_1382_n + (field_1381_o - field_1382_n) * f;
        field_4270_e *= f11;
        field_4269_f *= f11;
        field_4268_g *= f11;
        double d = (entityliving.field_637_aJ + (entityliving.field_610_al - entityliving.field_637_aJ) * (double)f) * world.field_4209_q.func_46065_j();
        ...
        if(field_1388_h.field_6304_y.field_1578_g)
        {
            float f12 = (field_4270_e * 30F + field_4269_f * 59F + field_4268_g * 11F) / 100F;
            float f13 = (field_4270_e * 30F + field_4269_f * 70F) / 100F;
            float f14 = (field_4270_e * 30F + field_4268_g * 70F) / 100F;
            field_4270_e = f12;
            field_4269_f = f13;
            field_4268_g = f14;
        }
    ...
    private void func_4140_a(int i, float f)
    {
        EntityLiving entityliving = field_1388_h.field_22009_h;
        boolean flag = false;
        ...
        GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
        int j = ActiveRenderInfo.func_41066_a(field_1388_h.field_6324_e, entityliving, f);
        if(entityliving.func_35160_a(Potion.field_35693_q))
        {
            float f1 = 5F;
            int k = entityliving.func_35167_b(Potion.field_35693_q).func_35802_b();
            if(k < 20)
            {
                f1 = 5F + (field_1387_i - 5F) * (1.0F - (float)k / 20F);
            }
            GL11.glFogi(2917, 9729);
            if(i < 0)
            {
        ...
        if(j > 0 && Block.field_345_n[j].field_356_bn == Material.field_1332_f)
        {
            GL11.glFogi(2917, 2048);
        ...
        if(j > 0 && Block.field_345_n[j].field_356_bn == Material.field_1331_g)
        {
            GL11.glFogi(2917, 2048);
        ...
        {
            float f5 = field_1387_i;
            if(field_1388_h.field_6324_e.field_4209_q.func_46064_i() && !flag)
            {
                double d = (double)((entityliving.func_35115_a(f) & 0xf00000) >> 20) / 16D + (entityliving.field_637_aJ + (entityliving.field_610_al - entityliving.field_637_aJ) * (double)f + 4D) / 32D;
                if(d < 1.0D)
                {
                    if(d < 0.0D)
                    {
            ...
            if(field_1388_h.field_6324_e.field_4209_q.field_4220_c)
            {
                GL11.glFogf(2915, 0.0F);
            }
        }
