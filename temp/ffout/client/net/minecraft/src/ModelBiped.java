...
public class ModelBiped extends ModelBase
{
    ...
    public ModelBiped(float f, float f1)
    {
        ...
        field_20097_i.func_923_a(-5F, 0.0F, -1F, 10, 16, 1, f);
        field_20098_h = new ModelRenderer(this, 24, 0);
        field_20098_h.func_923_a(-3F, -6F, -1F, 6, 6, 1, f);
    ...
    public void func_863_a(float f, float f1, float f2, float f3, float f4, float f5)
    {
        ...
        field_1283_d.field_1407_d = MathHelper.func_1114_b(f * 0.6662F + 3.141593F) * 2.0F * f1 * 0.5F;
        field_1282_e.field_1407_d = MathHelper.func_1114_b(f * 0.6662F) * 2.0F * f1 * 0.5F;
        field_1283_d.field_1405_f = 0.0F;
        field_1282_e.field_1405_f = 0.0F;
        field_1281_f.field_1407_d = MathHelper.func_1114_b(f * 0.6662F) * 1.4F * f1;
        field_1280_g.field_1407_d = MathHelper.func_1114_b(f * 0.6662F + 3.141593F) * 1.4F * f1;
        ...
        if(field_1244_k > -9990F)
        {
            ...
            field_1284_c.field_1406_e = MathHelper.func_1106_a(MathHelper.func_1113_c(f6) * 3.141593F * 2.0F) * 0.2F;
            ...
            float f10 = MathHelper.func_1106_a(field_1244_k * 3.141593F) * -(field_1286_a.field_1407_d - 0.7F) * 0.75F;
            field_1283_d.field_1407_d -= (double)f8 * 1.2D + (double)f10;
        ...
        if(field_40333_u)
        {
            ...
            field_1283_d.field_1405_f = 0.0F;
            field_1282_e.field_1405_f = 0.0F;
            field_1283_d.field_1406_e = -(0.1F - f7 * 0.6F) + field_1286_a.field_1406_e;
            field_1282_e.field_1406_e = (0.1F - f7 * 0.6F) + field_1286_a.field_1406_e + 0.4F;
            ...
            field_1283_d.field_1407_d -= f7 * 1.2F - f9 * 0.4F;
            field_1282_e.field_1407_d -= f7 * 1.2F - f9 * 0.4F;
            field_1283_d.field_1405_f += MathHelper.func_1114_b(f2 * 0.09F) * 0.05F + 0.05F;
            field_1282_e.field_1405_f -= MathHelper.func_1114_b(f2 * 0.09F) * 0.05F + 0.05F;
            field_1283_d.field_1407_d += MathHelper.func_1106_a(f2 * 0.067F) * 0.05F;
            field_1282_e.field_1407_d -= MathHelper.func_1106_a(f2 * 0.067F) * 0.05F;
    ...
    public void func_20095_a(float f)
    {
        ...
        field_20098_h.func_922_a(f);
    }

    public void func_20096_b(float f)
    {
        field_20097_i.func_922_a(f);
    }
}
