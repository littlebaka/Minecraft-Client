...
public class MapStorage
{
    ...
    public WorldSavedData func_28185_a(Class class1, String s)
    {
        WorldSavedData worldsaveddata = (WorldSavedData)field_28190_b.get(s);
        ...
        if(worldsaveddata != null)
        {
            field_28190_b.put(s, worldsaveddata);
            field_28193_c.add(worldsaveddata);
        }
        return worldsaveddata;
    }

    public void func_28184_a(String s, WorldSavedData worldsaveddata)
    {
        if(worldsaveddata == null)
        {
            throw new RuntimeException("Can't set null data");
        }
        if(field_28190_b.containsKey(s))
        {
            field_28193_c.remove(field_28190_b.remove(s));
        }
        field_28190_b.put(s, worldsaveddata);
        field_28193_c.add(worldsaveddata);
    }
    ...
    private void func_28189_a(WorldSavedData worldsaveddata)
    {
        if(field_28191_a == null)
        {
            return;
        ...
        try
        {
            File file = field_28191_a.func_28113_a(worldsaveddata.field_28168_a);
            if(file != null)
            {
                NBTTagCompound nbttagcompound = new NBTTagCompound();
                worldsaveddata.func_28162_b(nbttagcompound);
    ...
    public int func_28186_a(String s)
    {
        Short short1 = (Short)field_28192_d.get(s);
        if(short1 == null)
        {
        ...
        try
        {
            ...
            if(file != null)
            {
                ...
                String s1;
                short word0;
                for(Iterator iterator = field_28192_d.keySet().iterator(); iterator.hasNext(); nbttagcompound.func_749_a(s1, word0))
                {
                    s1 = (String)iterator.next();
                    word0 = ((Short)field_28192_d.get(s1)).shortValue();
                }
