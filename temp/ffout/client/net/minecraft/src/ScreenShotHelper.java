...
public class ScreenShotHelper
{
    ...
    public static String func_35879_a(File file, String s, int i, int j)
    {
        try
        {
            ...
            file1.mkdir();
            if(field_4286_b == null || field_4286_b.capacity() < i * j)
            {
                field_4286_b = BufferUtils.createByteBuffer(i * j * 3);
            }
            if(field_4288_d == null || field_4288_d.length < i * j * 3)
            {
            ...
            field_4286_b.clear();
            String s1 = (new StringBuilder()).append("").append(field_4287_a.format(new Date())).toString();
            File file2;
            if(s == null)
            {
