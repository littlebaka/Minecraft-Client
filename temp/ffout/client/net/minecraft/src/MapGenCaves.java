...
public class MapGenCaves extends MapGenBase
{
    ...
    protected void func_870_a(long l, int i, int j, byte abyte0[], double d, 
            double d1, double d2)
    {
        func_869_a(l, i, j, abyte0, d, d1, d2, 1.0F + field_1305_b.nextFloat() * 6F, 0.0F, 0.0F, -1, -1, 0.5D);
    }

    protected void func_869_a(long l, int i, int j, byte abyte0[], double d, 
            ...
            int k, int i1, double d3)
    {
        ...
        for(; k < i1; k++)
        {
            double d6 = 1.5D + (double)(MathHelper.func_1106_a(((float)k * 3.141593F) / (float)i1) * f * 1.0F);
            double d7 = d6 * d3;
            float f5 = MathHelper.func_1114_b(f2);
            float f6 = MathHelper.func_1106_a(f2);
            d += MathHelper.func_1114_b(f1) * f5;
            d1 += f6;
            d2 += MathHelper.func_1106_a(f1) * f5;
            if(flag1)
            {
                f2 *= 0.92F;
            } else
            ...
            {
                func_869_a(random.nextLong(), i, j, abyte0, d, d1, d2, random.nextFloat() * 0.5F + 0.5F, f1 - 1.570796F, f2 / 3F, k, i1, 1.0D);
                func_869_a(random.nextLong(), i, j, abyte0, d, d1, d2, random.nextFloat() * 0.5F + 0.5F, f1 + 1.570796F, f2 / 3F, k, i1, 1.0D);
                return;
            }
            ...
            if(i2 > field_35625_d.field_35472_c - 8)
            {
                i2 = field_35625_d.field_35472_c - 8;
            }
            if(d10 < 0)
            {
                d10 = 0;
            ...
            for(int k2 = d8; !flag2 && k2 < l1; k2++)
            {
                for(int i3 = d10; !flag2 && i3 < j2; i3++)
                {
                    ...
                    {
                        int k3 = (k2 * 16 + i3) * field_35625_d.field_35472_c + j3;
                        if(j3 < 0 || j3 >= field_35625_d.field_35472_c)
                        {
                            continue;
                        }
                        if(abyte0[k3] == Block.field_401_B.field_376_bc || abyte0[k3] == Block.field_399_C.field_376_bc)
                        {
                            flag2 = true;
                        }
...
label0:
                for(int l3 = d10; l3 < j2; l3++)
                {
                    ...
                    int i4 = (l2 * 16 + l3) * field_35625_d.field_35472_c + i2;
                    boolean flag3 = false;
                    ...
                    do
                    {
                        ...
                        if(d14 > -0.69999999999999996D && d12 * d12 + d14 * d14 + d13 * d13 < 1.0D)
                        {
                            ...
                            if(byte0 == Block.field_338_u.field_376_bc || byte0 == Block.field_336_w.field_376_bc || byte0 == Block.field_337_v.field_376_bc)
                            {
                                if(j4 < 10)
                                {
                                    abyte0[i4] = (byte)Block.field_397_D.field_376_bc;
                                } else
                                {
                                    abyte0[i4] = 0;
                                    if(flag3 && abyte0[i4 - 1] == Block.field_336_w.field_376_bc)
                                    {
                                        abyte0[i4 - 1] = field_35625_d.func_4075_a().func_4073_a(l2 + i * 16, l3 + j * 16).field_4242_o;
                                    }
                                }
                            }
                        }
    ...
    {
        int i1 = field_1305_b.nextInt(field_1305_b.nextInt(field_1305_b.nextInt(40) + 1) + 1);
        ...
        {
            double d = i * 16 + field_1305_b.nextInt(16);
            double d1 = field_1305_b.nextInt(field_1305_b.nextInt(world.field_35472_c - 8) + 8);
            double d2 = j * 16 + field_1305_b.nextInt(16);
            int k1 = 1;
            if(field_1305_b.nextInt(4) == 0)
            {
                func_870_a(field_1305_b.nextLong(), k, l, abyte0, d, d1, d2);
                k1 += field_1305_b.nextInt(4);
            }
            for(int l1 = 0; l1 < k1; l1++)
            {
                ...
                func_869_a(field_1305_b.nextLong(), k, l, abyte0, d, d1, d2, f2, f, f1, 0, 0, 1.0D);
            }
