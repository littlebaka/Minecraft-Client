...
public class TileEntityMobSpawner extends TileEntity
{
    ...
    public void func_21098_a(String s)
    {
        field_828_b = s;
    }
    ...
    public void func_482_a(NBTTagCompound nbttagcompound)
    {
        ...
        field_828_b = nbttagcompound.func_755_i("EntityId");
        field_829_a = nbttagcompound.func_745_d("Delay");
    }

    public void func_481_b(NBTTagCompound nbttagcompound)
    {
        super.func_481_b(nbttagcompound);
        nbttagcompound.func_754_a("EntityId", field_828_b);
        nbttagcompound.func_749_a("Delay", (short)field_829_a);
    }
}
