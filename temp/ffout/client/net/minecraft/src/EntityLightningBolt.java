...
public class EntityLightningBolt extends EntityWeatherEffect
{
    ...
    public EntityLightningBolt(World world, double d, double d1, double d2)
    {
        super(world);
        field_27029_a = 0L;
        func_365_c(d, d1, d2, 0.0F, 0.0F);
        field_27028_b = 2;
        field_27029_a = field_9312_bd.nextLong();
        field_27030_c = field_9312_bd.nextInt(3) + 1;
        if(world.field_1039_l >= 2 && world.func_21117_a(MathHelper.func_1108_b(d), MathHelper.func_1108_b(d1), MathHelper.func_1108_b(d2), 10))
        {
            int i = MathHelper.func_1108_b(d);
            int k = MathHelper.func_1108_b(d1);
            int i1 = MathHelper.func_1108_b(d2);
            if(world.func_600_a(i, k, i1) == 0 && Block.field_402_as.func_243_a(world, i, k, i1))
            {
                world.func_690_d(i, k, i1, Block.field_402_as.field_376_bc);
            }
            for(int j = 0; j < 4; j++)
            {
                int l = (MathHelper.func_1108_b(d) + field_9312_bd.nextInt(3)) - 1;
                int j1 = (MathHelper.func_1108_b(d1) + field_9312_bd.nextInt(3)) - 1;
                int k1 = (MathHelper.func_1108_b(d2) + field_9312_bd.nextInt(3)) - 1;
                if(world.func_600_a(l, j1, k1) == 0 && Block.field_402_as.func_243_a(world, l, j1, k1))
                {
                    world.func_690_d(l, j1, k1, Block.field_402_as.field_376_bc);
                }
            }
