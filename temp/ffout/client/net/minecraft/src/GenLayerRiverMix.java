...
public class GenLayerRiverMix extends GenLayer
{
    ...
    public int[] func_35500_a(int i, int j, int k, int l)
    {
        ...
        for(int i1 = 0; i1 < k * l; i1++)
        {
            ...
            if(ai1[i1] >= 0)
            {
                if(ai[i1] == BiomeGenBase.field_40257_n.field_35494_y)
                {
                    ai2[i1] = BiomeGenBase.field_40260_m.field_35494_y;
                    continue;
                }
                if(ai[i1] == BiomeGenBase.field_40262_p.field_35494_y || ai[i1] == BiomeGenBase.field_40261_q.field_35494_y)
                {
                    ai2[i1] = BiomeGenBase.field_40261_q.field_35494_y;
                } else
                {
                    ai2[i1] = ai1[i1];
                }
