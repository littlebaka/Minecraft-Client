...
public class GuiContainerCreative extends GuiContainer
{
    ...
    public GuiContainerCreative(EntityPlayer entityplayer)
    {
        ...
        field_35312_g = 0.0F;
        field_35313_h = false;
        entityplayer.field_20068_h = field_973_i;
        field_948_f = true;
    ...
    protected void func_35309_a(Slot slot, int i, int j, boolean flag)
    {
        if(slot != null)
        {
            ...
            {
                field_973_i.func_27280_a(slot.field_20007_a, j, flag, field_945_b.field_6322_g);
                ItemStack itemstack = field_973_i.func_20118_a(slot.field_20007_a).func_777_b();
                field_945_b.field_6327_b.func_35637_a(itemstack, (slot.field_20007_a - field_973_i.field_20122_e.size()) + 9 + 36);
            }
        } else
        {
            ...
            if(inventoryplayer1.func_20075_i() != null)
            {
                if(j == 0)
                {
                    field_945_b.field_6322_g.func_449_a(inventoryplayer1.func_20075_i());
                ...
                if(j == 1)
                {
                    ...
                    field_945_b.field_6322_g.func_449_a(itemstack3);
    ...
    {
        field_6451_g.func_873_b("Item selection", 8, 6, 0x404040);
    }
    ...
    {
        GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
        int k = field_945_b.field_6315_n.func_1070_a("/gui/allitems.png");
        ...
        int k1 = i1 + 17;
        int l1 = k1 + 160 + 2;
        func_550_b(l + 154, i1 + 17 + (int)((float)(l1 - k1 - 17) * field_35312_g), 0, 208, 16, 16);
    }
