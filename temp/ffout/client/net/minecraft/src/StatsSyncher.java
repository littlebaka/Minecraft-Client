...
public class StatsSyncher
{
    ...
    public StatsSyncher(Session session, StatFileWriter statfilewriter, File file)
    {
        ...
        field_27427_l = 0;
        field_27426_m = 0;
        field_27434_e = new File(file, (new StringBuilder()).append("stats_").append(session.field_1666_b.toLowerCase()).append("_unsent.dat").toString());
        field_27433_f = new File(file, (new StringBuilder()).append("stats_").append(session.field_1666_b.toLowerCase()).append(".dat").toString());
        field_27430_i = new File(file, (new StringBuilder()).append("stats_").append(session.field_1666_b.toLowerCase()).append("_unsent.old").toString());
        field_27429_j = new File(file, (new StringBuilder()).append("stats_").append(session.field_1666_b.toLowerCase()).append(".old").toString());
        field_27432_g = new File(file, (new StringBuilder()).append("stats_").append(session.field_1666_b.toLowerCase()).append("_unsent.tmp").toString());
        field_27431_h = new File(file, (new StringBuilder()).append("stats_").append(session.field_1666_b.toLowerCase()).append(".tmp").toString());
        if(!session.field_1666_b.toLowerCase().equals(session.field_1666_b))
        {
            func_28214_a(file, (new StringBuilder()).append("stats_").append(session.field_1666_b).append("_unsent.dat").toString(), field_27434_e);
            func_28214_a(file, (new StringBuilder()).append("stats_").append(session.field_1666_b).append(".dat").toString(), field_27433_f);
            func_28214_a(file, (new StringBuilder()).append("stats_").append(session.field_1666_b).append("_unsent.old").toString(), field_27430_i);
            func_28214_a(file, (new StringBuilder()).append("stats_").append(session.field_1666_b).append(".old").toString(), field_27429_j);
            func_28214_a(file, (new StringBuilder()).append("stats_").append(session.field_1666_b).append("_unsent.tmp").toString(), field_27432_g);
            func_28214_a(file, (new StringBuilder()).append("stats_").append(session.field_1666_b).append(".tmp").toString(), field_27431_h);
        }
        ...
        throws IOException
    {
        ...
        try
        {
            printwriter.print(StatFileWriter.func_27185_a(field_27428_k.field_1666_b, "local", map));
        }
        finally
        {
            printwriter.close();
