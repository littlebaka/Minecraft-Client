...
//            SaveHandler, WorldSettings, EnumWorldType, ThreadRunIsoClient, 
    ...
    implements KeyListener, MouseListener, MouseMotionListener, Runnable
{
    ...
    public void func_1268_a(Graphics2D graphics2d)
    {
        ...
        if(field_1790_d != null)
        {
            ...
            graphics2d.translate(-(chunkcoordinates.field_22395_a + chunkcoordinates.field_22396_c), -(-chunkcoordinates.field_22395_a + chunkcoordinates.field_22396_c) + 64);
        }
        ...
        int l = (rectangle.y + rectangle.height + 16 + field_1790_d.field_35472_c) / byte0 + 1 + byte1 * 2;
        for(int i1 = k; i1 <= l; i1++)
        {
            for(int k1 = i; k1 <= j; k1++)
            {
                ...
                if(!isoimagebuffer.field_1351_f)
                {
                    ...
                    int k2 = i1 * byte0 - field_1790_d.field_35472_c - 16;
