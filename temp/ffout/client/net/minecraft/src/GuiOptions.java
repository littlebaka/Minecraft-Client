...
public class GuiOptions extends GuiScreen
{
    ...
    {
        field_994_a = "Options";
        field_996_h = guiscreen;
        field_995_i = gamesettings;
    }
    ...
    protected void func_572_a(GuiButton guibutton)
    {
        ...
        {
            field_995_i.func_1045_b(((GuiSmallButton)guibutton).func_20078_a(), 1);
            guibutton.field_939_e = field_995_i.func_1043_a(EnumOptions.func_20137_a(guibutton.field_938_f));
        }
        if(guibutton.field_938_f == 101)
        {
            field_945_b.field_6304_y.func_1041_b();
            field_945_b.func_6272_a(new GuiVideoSettings(this, field_995_i));
        }
        if(guibutton.field_938_f == 100)
        {
            field_945_b.field_6304_y.func_1041_b();
            field_945_b.func_6272_a(new GuiControls(this, field_995_i));
        }
        if(guibutton.field_938_f == 102)
        {
            field_945_b.field_6304_y.func_1041_b();
