...
class GuiSlotStatsBlock extends GuiSlotStats
{
    ...
    public GuiSlotStatsBlock(GuiStats guistats)
    {
        ...
        do
        {
            ...
            if(StatList.field_25172_A[i] != null && GuiStats.func_27142_c(guistats).func_27184_a(StatList.field_25172_A[i]) > 0)
            {
                flag = true;
            } else
    ...
    protected void func_22242_a(int i, int j, int k, int l, Tessellator tessellator)
    {
        ...
        func_27265_a((StatCrafting)StatList.field_25158_z[i1], j + 115, k, i % 2 == 0);
        func_27265_a((StatCrafting)StatList.field_25172_A[i1], j + 165, k, i % 2 == 0);
