    ...
    implements IMob
{
    ...
    {
        if("fireball".equals(damagesource.func_40545_l()) && (damagesource.func_35532_a() instanceof EntityPlayer))
        {
            super.func_396_a(damagesource, 1000);
            ((EntityPlayer)damagesource.func_35532_a()).func_27026_a(AchievementList.field_40466_y);
            return true;
        } else
        {
    ...
    private boolean func_27023_a(double d, double d1, double d2, double d3)
    {
        double d4 = (field_20900_b - field_611_ak) / d3;
        double d5 = (field_20902_c - field_610_al) / d3;
        double d6 = (field_4126_d - field_609_am) / d3;
        AxisAlignedBB axisalignedbb = field_601_au.func_1160_c();
        for(int i = 1; (double)i < d3; i++)
        {
            axisalignedbb.func_1174_d(d4, d5, d6);
    ...
    {
        int j = field_9312_bd.nextInt(2) + field_9312_bd.nextInt(1 + i);
        for(int k = 0; k < j; k++)
        {
            func_367_b(Item.field_40418_bp.field_291_aS, 1);
        }

        j = field_9312_bd.nextInt(3) + field_9312_bd.nextInt(1 + i);
        for(int l = 0; l < j; l++)
        {
