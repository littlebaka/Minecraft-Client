...
public class RecipesIngots
{
    ...
    public void func_810_a(CraftingManager craftingmanager)
    {
        for(int i = 0; i < field_1198_a.length; i++)
        {
            ...
            craftingmanager.func_1121_a(new ItemStack(block), new Object[] {
                "###", "###", "###", Character.valueOf('#'), itemstack
            });
            craftingmanager.func_1121_a(itemstack, new Object[] {
                "#", Character.valueOf('#'), block
            });
        }

        craftingmanager.func_1121_a(new ItemStack(Item.field_222_n), new Object[] {
            "###", "###", "###", Character.valueOf('#'), Item.field_40419_bq
        });
        craftingmanager.func_1121_a(new ItemStack(Item.field_40419_bq, 9), new Object[] {
