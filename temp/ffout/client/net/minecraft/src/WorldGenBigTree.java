...
public class WorldGenBigTree extends WorldGenerator
{
        ...
        for(; j1 <= i1; j1++)
        {
            ...
            for(int l1 = -i1; l1 <= i1;)
            {
                ...
                } else
                {
                    ...
                    {
                        func_41060_a(field_880_c, ai1[0], ai1[1], ai1[2], l, 0);
                        l1++;
                    }
                }
            }
    ...
    void func_522_a(int ai[], int ai1[], int i)
    {
        ...
        for(int l = ai2[j] + byte3; k != l; k += byte3)
        {
            ...
            func_41060_a(field_880_c, ai3[0], ai3[1], ai3[2], i, 0);
        }
    ...
    int func_524_a(int ai[], int ai1[])
    {
        ...
        do
        {
            ...
            ai3[i] = ai[i] + j;
            ai3[byte1] = MathHelper.func_1108_b((double)ai[byte1] + (double)j * d);
            ai3[byte2] = MathHelper.func_1108_b((double)ai[byte2] + (double)j * d1);
