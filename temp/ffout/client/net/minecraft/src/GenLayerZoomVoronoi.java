...
public class GenLayerZoomVoronoi extends GenLayer
{
    ...
    public int[] func_35500_a(int i, int j, int k, int l)
    {
        ...
        int l1 = (k >> byte0) + 3;
        int i2 = (l >> byte0) + 3;
        int ai[] = field_35504_a.func_35500_a(j1, k1, l1, i2);
        int j2 = l1 << byte0;
        int k2 = i2 << byte0;
        int ai1[] = IntCache.func_35267_a(j2 * k2);
        for(int l2 = 0; l2 < i2 - 1; l2++)
        {
            ...
            for(int l3 = 0; l3 < l1 - 1; l3++)
            {
                ...
                func_35499_a(l3 + j1 << byte0, l2 + k1 << byte0);
                double d1 = ((double)func_35498_a(1024) / 1024D - 0.5D) * d;
                double d2 = ((double)func_35498_a(1024) / 1024D - 0.5D) * d;
                func_35499_a(l3 + j1 + 1 << byte0, l2 + k1 << byte0);
                double d3 = ((double)func_35498_a(1024) / 1024D - 0.5D) * d + (double)i1;
                double d4 = ((double)func_35498_a(1024) / 1024D - 0.5D) * d;
                func_35499_a(l3 + j1 << byte0, l2 + k1 + 1 << byte0);
                double d5 = ((double)func_35498_a(1024) / 1024D - 0.5D) * d;
                double d6 = ((double)func_35498_a(1024) / 1024D - 0.5D) * d + (double)i1;
                func_35499_a(l3 + j1 + 1 << byte0, l2 + k1 + 1 << byte0);
                double d7 = ((double)func_35498_a(1024) / 1024D - 0.5D) * d + (double)i1;
                double d8 = ((double)func_35498_a(1024) / 1024D - 0.5D) * d + (double)i1;
