...
public class FurnaceRecipes
{
    ...
    public void func_21199_a(int i, ItemStack itemstack)
    {
        field_21201_b.put(Integer.valueOf(i), itemstack);
    }

    public ItemStack func_21198_a(int i)
    {
        return (ItemStack)field_21201_b.get(Integer.valueOf(i));
    }
