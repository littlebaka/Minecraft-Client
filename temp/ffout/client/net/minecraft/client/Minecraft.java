    ...
    implements Runnable
{
    ...
    {
        field_28004_R = true;
        func_4007_a(unexpectedthrowable);
    }
        ...
        throws LWJGLException
    {
        ...
        field_22008_V = new SaveConverterMcRegion(new File(field_6297_D, "saves"));
    ...
    public void func_6272_a(GuiScreen guiscreen)
    {
        ...
        if(guiscreen == null && field_6322_g.func_40114_aH() <= 0)
        {
    ...
    public void run()
    {
        ...
        try
        {
            while(field_6293_H) 
            {
                ...
                {
                    func_28002_e();
                    func_6272_a(new GuiErrorScreen());
                    System.gc();
                }
            }
        }
...
_L3:
    ...
    private void func_6238_a(long l)
    {
        ...
        for(int i1 = 0; i1 < field_9240_E.length; i1++)
        {
            ...
            tessellator.func_991_a((float)i1 + 0.5F, (float)((long)field_6325_d - l4) + 0.5F, 0.0D);
            ...
            tessellator.func_991_a((float)i1 + 0.5F, (float)((long)field_6325_d - l4) + 0.5F, 0.0D);
            tessellator.func_991_a((float)i1 + 0.5F, (float)((long)field_6325_d - (l4 - l5)) + 0.5F, 0.0D);
        }
        ...
        int j4 = 0xffffff;
        field_6314_o.func_874_a(s, i2 - j1, k2 - j1 / 2 - 16, j4);
        field_6314_o.func_874_a(s = (new StringBuilder()).append(decimalformat.format(profilerresult.field_40702_b)).append("%").toString(), (i2 + j1) - field_6314_o.func_871_a(s), k2 - j1 / 2 - 16, j4);
        for(int k3 = 0; k3 < list.size(); k3++)
        {
            ...
            field_6314_o.func_874_a(s1, i2 - j1, k2 + j1 / 2 + k3 * 8 + 20, profilerresult2.func_40700_a());
            field_6314_o.func_874_a(s1 = (new StringBuilder()).append(decimalformat.format(profilerresult2.field_40704_a)).append("%").toString(), (i2 + j1) - 50 - field_6314_o.func_871_a(s1), k2 + j1 / 2 + k3 * 8 + 20, profilerresult2.func_40700_a());
            field_6314_o.func_874_a(s1 = (new StringBuilder()).append(decimalformat.format(profilerresult2.field_40702_b)).append("%").toString(), (i2 + j1) - field_6314_o.func_871_a(s1), k2 + j1 / 2 + k3 * 8 + 20, profilerresult2.func_40700_a());
        }
    ...
    private void func_6254_a(int i, boolean flag)
    {
        ...
        if(flag && field_6305_x != null && field_6305_x.field_1167_a == EnumMovingObjectType.TILE && i == 0)
        {
            int j = field_6305_x.field_1166_b;
            int k = field_6305_x.field_1172_c;
            int l = field_6305_x.field_1171_d;
            field_6327_b.func_6470_c(j, k, l, field_6305_x.field_1170_e);
            if(field_6322_g.func_35190_e(j, k, l))
            {
                field_6321_h.func_1191_a(j, k, l, field_6305_x.field_1170_e);
    ...
    private void func_6243_a(int i)
    {
        ...
        {
            if(i == 0 && field_6327_b.func_35641_g())
            {
                field_6282_S = 10;
            }
        } else
        ...
        if(field_6305_x.field_1167_a == EnumMovingObjectType.TILE)
        {
            ...
            int k = field_6305_x.field_1172_c;
            int l = field_6305_x.field_1171_d;
            int i1 = field_6305_x.field_1170_e;
            if(i == 0)
            {
                field_6327_b.func_719_a(j, k, l, field_6305_x.field_1170_e);
            } else
            {
                ItemStack itemstack2 = itemstack;
                int j1 = itemstack2 == null ? 0 : itemstack2.field_1615_a;
                if(field_6327_b.func_722_a(field_6322_g, field_6324_e, itemstack2, j, k, l, i1))
                {
                    flag = false;
                    field_6322_g.func_457_w();
                }
                ...
                if(itemstack2.field_1615_a != j1 || field_6327_b.func_35640_h())
                {
    ...
    private void func_6249_a(int i, int j)
    {
        ...
        if(field_6313_p != null)
        {
            ScaledResolution scaledresolution = new ScaledResolution(field_6304_y, i, j);
    ...
    public void func_6246_i()
    {
        ...
        if(field_6313_p == null || field_6313_p.field_948_f)
        {
            ...
            for(; field_6304_y.field_6523_q.func_35962_c(); field_6322_g.func_20060_w()) { }
    ...
    public void func_6247_b(String s, String s1, WorldSettings worldsettings)
    {
        func_6261_a(null);
        System.gc();
        ...
        } else
        {
            ...
            net.minecraft.src.ISaveHandler isavehandler = field_22008_V.func_22174_a(s, false);
            World world = null;
    ...
    public void func_6237_k(int i)
    {
        int j = field_6322_g.field_4129_m;
        field_6322_g.field_4129_m = i;
        ...
        double d2 = 1.0D;
        if(j > -1 && field_6322_g.field_4129_m == -1)
        {
            d2 = 0.125D;
        } else
        if(j == -1 && field_6322_g.field_4129_m > -1)
        ...
        if(field_6322_g.func_354_B() && j < 1)
        {
            field_6322_g.func_365_c(d, field_6322_g.field_610_al, d1, field_6322_g.field_605_aq, field_6322_g.field_604_ar);
            field_6324_e.func_4084_a(field_6322_g, false);
    ...
    public void func_6256_a(World world, String s, EntityPlayer entityplayer)
    {
        ...
        if(world != null)
        {
            ...
            if(!func_6260_j())
            {
                ...
                {
                    field_6322_g = (EntityPlayerSP)world.func_4085_a(net.minecraft.src.EntityPlayerSP.class);
                }
            } else
            if(field_6322_g != null)
            {
            ...
            net.minecraft.src.IChunkProvider ichunkprovider = world.func_21118_q();
            if(ichunkprovider instanceof ChunkProviderLoadOrGenerate)
            {
                ChunkProviderLoadOrGenerate chunkproviderloadorgenerate = (ChunkProviderLoadOrGenerate)ichunkprovider;
    ...
    private void func_22002_b(String s, String s1)
    {
        ...
        field_22008_V.func_22171_a(s, field_6312_q);
        func_6247_b(s, s1, new WorldSettings(0L, 0, true, false, EnumWorldType.DEFAULT));
    }
    ...
    public void func_6239_p(boolean flag, int i, boolean flag1)
    {
    ...
    private void func_6265_t()
    {
        if(field_6305_x != null)
        {
            ...
            field_6322_g.field_778_b.func_496_a(i, j, flag, field_6327_b instanceof PlayerControllerCreative);
        }
    }
