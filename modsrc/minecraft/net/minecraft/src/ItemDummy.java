...
public class ItemDummy extends Item
{
    ...
    public ItemStack onItemRightClick(ItemStack itemstack, World world, EntityPlayer entityplayer)
    {
        ...
        if (movingobjectposition.typeOfHit == EnumMovingObjectType.TILE)
        {
            ...
            EntityDummy wm_entitydummy = new EntityDummy(world, (float)i + 0.5F, (float)j + 1.0F, (float)k + 0.5F);
            wm_entitydummy.rotationYaw = entityplayer.rotationYaw;
            world.spawnEntityInWorld(wm_entitydummy);
