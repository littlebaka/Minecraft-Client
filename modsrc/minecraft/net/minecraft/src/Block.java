...
public class Block
{
    ...
    static
    {
        ...
        //iCraftEvo Begin TODO
        jump = (new BlockJump(142, 4)).setHardness(1.0F).setStepSound(Block.soundClothFootstep).setBlockName("jump"); //image à côté du rail détecteur.
        lampadaire = (new BlockGlowStone(140, 30, Material.glass)).setHardness(0.3F).setStepSound(soundGlassFootstep).setLightValue(1.0F).setBlockName("lampadaire"); //image à côté du champignon
        fenceFer = (new BlockFence(143, 22)).setHardness(2.0F).setResistance(5F).setStepSound(soundWoodFootstep).setBlockName("fenceFer");
        barrel = (new BlockBarrel(141, 229)).setHardness(2.0F).setResistance(5F).setStepSound(soundWoodFootstep).setBlockName("barrel"); // 2 images à la suite à côté des chanpignons du nether.
        muret = (new BlockMuret(144, stoneBrick)).setBlockName("muret");
        //iCraftEvo End
