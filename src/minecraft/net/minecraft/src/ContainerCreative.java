...
class ContainerCreative extends Container
{
    ...
    public ContainerCreative(EntityPlayer entityplayer)
    {
        ...
        Block ablock[] = {
            Block.cobblestone, Block.stone, Block.oreDiamond, Block.oreGold, Block.oreIron, Block.oreCoal, Block.oreLapis, Block.oreRedstone, Block.stoneBrick, Block.stoneBrick, Block.walldirt,
            ...
            Block.stairSingle, Block.stairSingle, Block.stairSingle, Block.stairSingle, Block.stairSingle, Block.obsidian, Block.netherrack, Block.slowSand, Block.glowStone, Block.lamp, Block.barrel, Block.jump, Block.wood, 
            ...
            Block.glass, Block.glass, Block.glass, Block.glass, Block.glass, Block.glass, Block.glass, Block.glass, 
            Block.glass, Block.glass, Block.glass, Block.glass, Block.glass, Block.glass, Block.glass, Block.glass, Block.tnt, Block.bookShelf, Block.cloth, Block.cloth, Block.cloth, Block.cloth, Block.cloth, Block.cloth, Block.cloth, 
