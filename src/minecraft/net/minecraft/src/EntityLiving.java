...
public abstract class EntityLiving extends Entity
{
    ...
    public void heal(int i)
    {
        ...
        worldObj.entityJoinedWorld(new EntityDSplashFX(worldObj, i, posX, posY, posZ));//TODO
    }
    ...
    public boolean attackEntityFrom(DamageSource damagesource, int i)
    {
        ...
        attackedAtYaw = 0.0F;
        worldObj.entityJoinedWorld(new EntityDSplashFX(worldObj, damagesource, i, posX, posY, posZ));//TODO spawnEntityInWorld
