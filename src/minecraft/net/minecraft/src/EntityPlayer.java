...
public abstract class EntityPlayer extends EntityLiving
{
    ...
    {
        playerCloakUrl = (new StringBuilder()).append("http://icraftevo.fr/Launcher/MinecraftCloaks/").append(username).append(".png").toString(); //TODO default: http://s3.amazonaws.com/MinecraftCloaks/
