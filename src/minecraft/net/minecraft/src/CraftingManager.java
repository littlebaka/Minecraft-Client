...
public class CraftingManager
{
    ...
    private CraftingManager()
    {
        ...
        //(new RecipesBackpack()).addRecipes(this);
        ...
        //Nouveaux crafts :
        addRecipe(new ItemStack(Block.lamp, 1), new Object[] {
            " # ", "#D#", " # ", Character.valueOf('#'), Item.ingotIron, Character.valueOf('D'), Block.glowStone
        });
        addRecipe(new ItemStack(Block.barrel, 1), new Object[] {
            "D#D", " # ", "D#D", Character.valueOf('D'), Item.ingotIron, Character.valueOf('#'), Block.planks
        });
        addRecipe(new ItemStack(Block.jump, 1), new Object[] {
        	"X#X","X X","XXX", Character.valueOf('X'), Block.planks, Character.valueOf('#'), Item.leather
        });
        /*addRecipe(new ItemStack(Item.backpack, 1, 16), new Object[] {
            "PPP", "P P", "PPP", Character.valueOf('P'), Item.leather
        });
        addRecipe(new ItemStack(Item.backpack, 1, 0), new Object[] {
            "PPP", "PXP", "PPP", Character.valueOf('P'), Item.leather, Character.valueOf('X'), new ItemStack(Item.dyePowder, 1, 0)
        });
        addRecipe(new ItemStack(Item.backpack, 1, 1), new Object[] {
            "PPP", "PXP", "PPP", Character.valueOf('P'), Item.leather, Character.valueOf('X'), new ItemStack(Item.dyePowder, 1, 1)
        });
        addRecipe(new ItemStack(Item.backpack, 1, 2), new Object[] {
            "PPP", "PXP", "PPP", Character.valueOf('P'), Item.leather, Character.valueOf('X'), new ItemStack(Item.dyePowder, 1, 2)
        });
        addRecipe(new ItemStack(Item.backpack, 1, 3), new Object[] {
            "PPP", "PXP", "PPP", Character.valueOf('P'), Item.leather, Character.valueOf('X'), new ItemStack(Item.dyePowder, 1, 3)
        });
        addRecipe(new ItemStack(Item.backpack, 1, 4), new Object[] {
            "PPP", "PXP", "PPP", Character.valueOf('P'), Item.leather, Character.valueOf('X'), new ItemStack(Item.dyePowder, 1, 4)
        });
        addRecipe(new ItemStack(Item.backpack, 1, 5), new Object[] {
            "PPP", "PXP", "PPP", Character.valueOf('P'), Item.leather, Character.valueOf('X'), new ItemStack(Item.dyePowder, 1, 5)
        });
        addRecipe(new ItemStack(Item.backpack, 1, 6), new Object[] {
            "PPP", "PXP", "PPP", Character.valueOf('P'), Item.leather, Character.valueOf('X'), new ItemStack(Item.dyePowder, 1, 6)
        });
        addRecipe(new ItemStack(Item.backpack, 1, 7), new Object[] {
            "PPP", "PXP", "PPP", Character.valueOf('P'), Item.leather, Character.valueOf('X'), new ItemStack(Item.dyePowder, 1, 7)
        });
        addRecipe(new ItemStack(Item.backpack, 1, 8), new Object[] {
            "PPP", "PXP", "PPP", Character.valueOf('P'), Item.leather, Character.valueOf('X'), new ItemStack(Item.dyePowder, 1, 8)
        });
        addRecipe(new ItemStack(Item.backpack, 1, 9), new Object[] {
            "PPP", "PXP", "PPP", Character.valueOf('P'), Item.leather, Character.valueOf('X'), new ItemStack(Item.dyePowder, 1, 9)
        });
        addRecipe(new ItemStack(Item.backpack, 1, 10), new Object[] {
            "PPP", "PXP", "PPP", Character.valueOf('P'), Item.leather, Character.valueOf('X'), new ItemStack(Item.dyePowder, 1, 10)
        });
        addRecipe(new ItemStack(Item.backpack, 1, 11), new Object[] {
            "PPP", "PXP", "PPP", Character.valueOf('P'), Item.leather, Character.valueOf('X'), new ItemStack(Item.dyePowder, 1, 11)
        });
        addRecipe(new ItemStack(Item.backpack, 1, 12), new Object[] {
            "PPP", "PXP", "PPP", Character.valueOf('P'), Item.leather, Character.valueOf('X'), new ItemStack(Item.dyePowder, 1, 12)
        });
        addRecipe(new ItemStack(Item.backpack, 1, 13), new Object[] {
            "PPP", "PXP", "PPP", Character.valueOf('P'), Item.leather, Character.valueOf('X'), new ItemStack(Item.dyePowder, 1, 13)
        });
        addRecipe(new ItemStack(Item.backpack, 1, 14), new Object[] {
            "PPP", "PXP", "PPP", Character.valueOf('P'), Item.leather, Character.valueOf('X'), new ItemStack(Item.dyePowder, 1, 14)
        });
        addRecipe(new ItemStack(Item.backpack, 1, 15), new Object[] {
            "PPP", "PXP", "PPP", Character.valueOf('P'), Item.leather, Character.valueOf('X'), new ItemStack(Item.dyePowder, 1, 15)
        });
        addRecipe(new ItemStack(Item.dummy, 1), new Object[] { //TODO
            "P", Character.valueOf('P'), Block.dirt
        });*/
        addRecipe(new ItemStack(Item.backpack, 1, 16), new Object[] {
            "P", Character.valueOf('P'), Block.dirt
        });
       ...
       for(int i = 0; i < 16; i++)
       {
    	   addRecipe(new ItemStack(Item.backpack, 1, i), new Object[] {
               "PPP", "PXP", "PPP", Character.valueOf('P'), Item.leather, Character.valueOf('X'), new ItemStack(Item.dyePowder, 1, i)
           });   
       }
        addRecipe(new ItemStack(Item.magicBackpack, 1), new Object[] {
            "#P#", "PXP", "#P#", Character.valueOf('P'), Item.enderdragonScale, Character.valueOf('X'), Item.backpack, Character.valueOf('#'), Item.silk
        });
        addRecipe(new ItemStack(Item.dummy, 1), new Object[] {
            " U ", "XOX", " # ", Character.valueOf('#'), Item.stick, Character.valueOf('X'), Item.wheat, Character.valueOf('O'), Item.plateLeather, Character.valueOf('U'), 
            Block.cloth
        });
        //Fin
